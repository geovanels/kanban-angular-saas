...
__name(ApiLinksConfigComponent_Conditional_3_Template, "ApiLinksConfigComponent_Conditional_3_Template");
...
__name(ApiLinksConfigComponent_Conditional_4_Template, "ApiLinksConfigComponent_Conditional_4_Template");
...
__name(ApiLinksConfigComponent_Conditional_6_Template, "ApiLinksConfigComponent_Conditional_6_Template");
...
__name(ApiLinksConfigComponent_Conditional_7_Template, "ApiLinksConfigComponent_Conditional_7_Template");
...
__name(ApiLinksConfigComponent_p_34_Template, "ApiLinksConfigComponent_p_34_Template");
...
__name(ApiLinksConfigComponent_p_35_Template, "ApiLinksConfigComponent_p_35_Template");
var _ApiLinksConfigComponent = class _ApiLinksConfigComponent {
...
__publicField(_ApiLinksConfigComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ApiLinksConfigComponent, selectors: [["app-api-links-config"]], decls: 61, vars: 15, consts: [["title", "API e Integra\xE7\xF5es"], [1, "bg-green-500", "hover:bg-green-600", "text-white", "px-4", "py-2", "rounded-lg", "text-sm", "font-medium", "transition-colors", 3, "click", "disabled"], [1, "max-w-7xl", "mx-auto", "px-4", "sm:px-6", "lg:px-8", "py-8"], [1, "mb-6", "p-4", "bg-green-50", "border", "border-green-200", "rounded-lg", "text-green-800"], [1, "mb-6", "p-4", "bg-red-50", "border", "border-red-200", "rounded-lg", "text-red-800"], [1, "bg-white", "rounded-lg", "shadow-sm", "border", "border-gray-200", "mb-8"], [1, "p-6", "border-b", "border-gray-200"], [1, "text-lg", "font-semibold", "text-gray-900", "flex", "items-center"], [1, "fas", "fa-plug", "text-blue-500", "mr-2"], [1, "text-sm", "text-gray-600", "mt-1"], [1, "p-6"], [1, "grid", "grid-cols-1", "lg:grid-cols-2", "gap-6"], [1, "space-y-4"], [1, "block", "text-sm", "font-medium", "text-gray-700", "mb-2"], [1, "flex", "items-center", "space-x-3"], [1, "relative", "inline-flex", "items-center", "cursor-pointer"], ["type", "checkbox", 1, "sr-only", "peer", 3, "change", "checked"], [1, "w-11", "h-6", "bg-gray-200", "peer-focus:outline-none", "peer-focus:ring-4", "peer-focus:ring-blue-300", "rounded-full", "peer", "peer-checked:after:translate-x-full", "peer-checked:after:border-white", "after:content-['']", "after:absolute", "after:top-[2px]", "after:left-[2px]", "after:bg-white", "after:border-gray-300", "after:border", "after:rounded-full", "after:h-5", "after:w-5", "after:transition-all", "peer-checked:bg-blue-600"], [1, "flex", "space-x-2"], ["type", "text", "readonly", "", 1, "flex-1", "px-3", "py-2", "border", "border-gray-300", "rounded-md", "bg-gray-50", "text-gray-600", 3, "value"], [1, "bg-gray-500", "hover:bg-gray-600", "text-white", "px-3", "py-2", "rounded-md", "text-sm", "transition-colors", 3, "click"], [1, "fas", "fa-copy"], ["class", "text-xs text-gray-500 mt-1", 4, "ngIf"], ["type", "text", "readonly", "", 1, "flex-1", "px-3", "py-2", "border", "border-gray-300", "rounded-md", "font-mono", "text-sm", 3, "value"], [1, "bg-blue-500", "hover:bg-blue-600", "text-white", "px-3", "py-2", "rounded-md", "text-sm", "transition-colors", 3, "click"], [1, "text-xs", "text-gray-500", "mt-1"], [1, "w-full", "bg-orange-500", "hover:bg-orange-600", "text-white", "px-4", "py-2", "rounded-md", "text-sm", "font-medium", "transition-colors", 3, "click"], [1, "fas", "fa-sync-alt", "mr-1"], [1, "mt-6", "pt-6", "border-t", "border-gray-200"], [1, "text-md", "font-medium", "text-gray-900", "mb-4"], ["type", "url", "placeholder", "https://exemplo.com/webhook", 1, "w-full", "px-3", "py-2", "border", "border-gray-300", "rounded-md", "focus:ring-blue-500", "focus:border-blue-500", 3, "ngModelChange", "input", "ngModel"], [1, "fas", "fa-spinner", "fa-spin", "mr-1"], [1, "fas", "fa-save", "mr-1"], [1, "fas", "fa-check-circle", "mr-2"], [1, "fas", "fa-exclamation-circle", "mr-2"]], template: /* @__PURE__ */ __name(function ApiLinksConfigComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("change", /* @__PURE__ */ __name(function ApiLinksConfigComponent_Template_input_change_25_listener($event) {
      return ctx.toggleApiStatus($event.target.checked);
    }, "ApiLinksConfigComponent_Template_input_change_25_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275element(26, "div", 17);
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function ApiLinksConfigComponent_Template_button_click_32_listener() {
      return ctx.copyToClipboard(ctx.getLeadIntakeUrl());
    }, "ApiLinksConfigComponent_Template_button_click_32_listener"));
    \u0275\u0275element(33, "i", 21);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function ApiLinksConfigComponent_Template_button_click_42_listener() {
      return ctx.toggleTokenVisibility();
    }, "ApiLinksConfigComponent_Template_button_click_42_listener"));
    \u0275\u0275element(43, "i");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(44, "button", 24);
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function ApiLinksConfigComponent_Template_button_click_44_listener() {
      return ctx.copyToClipboard(ctx.apiToken());
    }, "ApiLinksConfigComponent_Template_button_click_44_listener"));
    \u0275\u0275element(45, "i", 21);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function ApiLinksConfigComponent_Template_button_click_49_listener() {
      return ctx.regenerateApiToken();
    }, "ApiLinksConfigComponent_Template_button_click_49_listener"));
    \u0275\u0275element(50, "i", 27);
    ...
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function ApiLinksConfigComponent_Template_input_ngModelChange_58_listener($event) {
      \u0275\u0275twoWayBindingSet(ctx.webhookUrl, $event) || (ctx.webhookUrl = $event);
      return $event;
    }, "ApiLinksConfigComponent_Template_input_ngModelChange_58_listener"));
    \u0275\u0275listener("input", /* @__PURE__ */ __name(function ApiLinksConfigComponent_Template_input_input_58_listener($event) {
      return ctx.webhookUrl.set($event.target.value);
    }, "ApiLinksConfigComponent_Template_input_input_58_listener"));
    \u0275\u0275elementEnd();
...
}, "ApiLinksConfigComponent_Template"), dependencies: [CommonModule, NgIf, FormsModule, DefaultValueAccessor, NgControlStatus, NgModel, ConfigHeaderComponent, MainLayoutComponent], styles: ["\n\n[_nghost-%COMP%] {\n  display: block;\n}\n/*# sourceMappingURL=api-links-config.component.css.map */"] }));
var ApiLinksConfigComponent = _ApiLinksConfigComponent;
(() => {
...
//# sourceMappingURL=chunk-62BXIHRK.js.map
