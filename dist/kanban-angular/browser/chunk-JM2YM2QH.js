...
var BrandingService = class _BrandingService {
  ...
  applyCompanyBranding(company) {
    console.log("\u{1F3A8} Aplicando branding para empresa:", company.name);
    console.log("\u{1F3A8} Cores da empresa:", {
    ...
    if (primaryColor || secondaryColor) {
      console.log("\u{1F3A8} Aplicando cores:", { primaryColor, secondaryColor });
      this.applyColors({
        primaryColor,
        secondaryColor
      });
  ...
  applyDynamicStyles(colors) {
    console.log("\u{1F3A8} Aplicando estilos din\xE2micos:", colors);
    if (!colors.primaryColor) {
      console.log("\u26A0\uFE0F Nenhuma cor prim\xE1ria fornecida");
      return;
    }
    const existingStyle = document.getElementById("dynamic-branding-styles");
    if (existingStyle) {
      existingStyle.remove();
      console.log("\u{1F5D1}\uFE0F Removeu estilos din\xE2micos anteriores");
    }
    const style = document.createElement("style");
    ...
    document.head.appendChild(style);
    console.log("\u2705 Estilos din\xE2micos aplicados com sucesso!");
    console.log("\u{1F3A8} Cor prim\xE1ria aplicada:", colors.primaryColor);
  }
  // Aplicar favicon
  ...
  static \u0275fac = function BrandingService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _BrandingService)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _BrandingService, factory: _BrandingService.\u0275fac, providedIn: "root" });
};
(() => {
...
//# sourceMappingURL=chunk-JM2YM2QH.js.map
