...
var _FunctionsError = class _FunctionsError extends FirebaseError {
  /**
...
var FunctionsError = _FunctionsError;
...
__name(codeForHTTPStatus, "codeForHTTPStatus");
...
__name(_errorForResponse, "_errorForResponse");
var _ContextProvider = class _ContextProvider {
...
__name(_ContextProvider, "ContextProvider");
...
__name(failAfter, "failAfter");
var _FunctionsService = class _FunctionsService {
  /**
...
__name(_FunctionsService, "FunctionsService");
var FunctionsService = _FunctionsService;
...
__name(connectFunctionsEmulator$1, "connectFunctionsEmulator$1");
function httpsCallable$1(functionsInstance, name2, options) {
  const callable = /* @__PURE__ */ __name((data) => {
...
__name(httpsCallable$1, "httpsCallable$1");
...
__name(httpsCallableFromURL$1, "httpsCallableFromURL$1");
...
__name(makeAuthHeaders, "makeAuthHeaders");
...
__name(streamAtURL, "streamAtURL");
function createResponseStream(reader, resultResolver, resultRejecter, signal) {
  const processLine = /* @__PURE__ */ __name((line, controller) => {
...
__name(createResponseStream, "createResponseStream");
...
function registerFunctions(variant) {
  const factory = /* @__PURE__ */ __name((container, { instanceIdentifier: regionOrCustomDomain }) => {
...
__name(registerFunctions, "registerFunctions");
...
__name(getFunctions, "getFunctions");
function connectFunctionsEmulator(functionsInstance, host, port) {
  connectFunctionsEmulator$1(getModularInstance(functionsInstance), host, port);
}
__name(connectFunctionsEmulator, "connectFunctionsEmulator");
...
__name(httpsCallable, "httpsCallable");
...
__name(httpsCallableFromURL, "httpsCallableFromURL");
registerFunctions();
...
__name(httpsCallable2, "httpsCallable");

// node_modules/@angular/fire/fesm2022/angular-fire-functions.mjs
var _Functions = class _Functions {
  constructor(functions) {
    return functions;
  }
};
__name(_Functions, "Functions");
var Functions = _Functions;
var FUNCTIONS_PROVIDER_NAME = "functions";
var _FunctionsInstances = class _FunctionsInstances {
  constructor() {
    return \u0275getAllInstancesOf(FUNCTIONS_PROVIDER_NAME);
  }
};
__name(_FunctionsInstances, "FunctionsInstances");
var FunctionsInstances = _FunctionsInstances;
...
__name(defaultFunctionsInstanceFactory, "defaultFunctionsInstanceFactory");
...
__name(functionsInstanceFactory, "functionsInstanceFactory");
...
__name(_FunctionsModule, "FunctionsModule");
__publicField(_FunctionsModule, "\u0275fac", /* @__PURE__ */ __name(function FunctionsModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _FunctionsModule)();
}, "FunctionsModule_Factory"));
__publicField(_FunctionsModule, "\u0275mod", /* @__PURE__ */ \u0275\u0275defineNgModule({
  type: _FunctionsModule
}));
__publicField(_FunctionsModule, "\u0275inj", /* @__PURE__ */ \u0275\u0275defineInjector({
...
__name(provideFunctions, "provideFunctions");
...
rxfire/functions/index.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-CPSVUG3M.js.map
