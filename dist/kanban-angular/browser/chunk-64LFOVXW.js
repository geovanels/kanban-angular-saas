...
var _forTrack0 = /* @__PURE__ */ __name(($index, $item) => $item.name, "_forTrack0");
...
__name(BrandingConfigComponent_Conditional_3_Template, "BrandingConfigComponent_Conditional_3_Template");
...
__name(BrandingConfigComponent_Conditional_4_Template, "BrandingConfigComponent_Conditional_4_Template");
...
__name(BrandingConfigComponent_Conditional_6_Template, "BrandingConfigComponent_Conditional_6_Template");
...
__name(BrandingConfigComponent_Conditional_7_Template, "BrandingConfigComponent_Conditional_7_Template");
...
__name(BrandingConfigComponent_Conditional_19_Template, "BrandingConfigComponent_Conditional_19_Template");
...
__name(BrandingConfigComponent_Conditional_20_Template, "BrandingConfigComponent_Conditional_20_Template");
...
__name(BrandingConfigComponent_Conditional_47_Template, "BrandingConfigComponent_Conditional_47_Template");
...
__name(BrandingConfigComponent_Conditional_48_Template, "BrandingConfigComponent_Conditional_48_Template");
function BrandingConfigComponent_Conditional_56_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 61);
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function BrandingConfigComponent_Conditional_56_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.removeLogo());
    }, "BrandingConfigComponent_Conditional_56_Template_button_click_0_listener"));
    \u0275\u0275element(1, "i", 62);
    \u0275\u0275text(2, " Remover Logo ");
    \u0275\u0275elementEnd();
  }
}
__name(BrandingConfigComponent_Conditional_56_Template, "BrandingConfigComponent_Conditional_56_Template");
function BrandingConfigComponent_For_84_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 63);
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function BrandingConfigComponent_For_84_Template_button_click_0_listener() {
      const preset_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.applyColorPreset(preset_r6));
    }, "BrandingConfigComponent_For_84_Template_button_click_0_listener"));
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
__name(BrandingConfigComponent_For_84_Template, "BrandingConfigComponent_For_84_Template");
function BrandingConfigComponent_Conditional_101_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function BrandingConfigComponent_Conditional_101_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.showDeleteModal());
    }, "BrandingConfigComponent_Conditional_101_Template_button_click_8_listener"));
    \u0275\u0275element(9, "i", 62);
    \u0275\u0275text(10, " Excluir Empresa Permanentemente ");
    \u0275\u0275elementEnd()()();
  }
}
__name(BrandingConfigComponent_Conditional_101_Template, "BrandingConfigComponent_Conditional_101_Template");
...
__name(BrandingConfigComponent_Conditional_102_Conditional_32_Template, "BrandingConfigComponent_Conditional_102_Conditional_32_Template");
...
__name(BrandingConfigComponent_Conditional_102_Conditional_37_Template, "BrandingConfigComponent_Conditional_102_Conditional_37_Template");
...
__name(BrandingConfigComponent_Conditional_102_Conditional_38_Template, "BrandingConfigComponent_Conditional_102_Conditional_38_Template");
function BrandingConfigComponent_Conditional_102_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function BrandingConfigComponent_Conditional_102_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.hideDeleteModal());
    }, "BrandingConfigComponent_Conditional_102_Template_button_click_7_listener"));
    \u0275\u0275element(8, "i", 74);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function BrandingConfigComponent_Conditional_102_Template_input_ngModelChange_31_listener($event) {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.deleteConfirmation, $event) || (ctx_r1.deleteConfirmation = $event);
      return \u0275\u0275resetView($event);
    }, "BrandingConfigComponent_Conditional_102_Template_input_ngModelChange_31_listener"));
    \u0275\u0275listener("input", /* @__PURE__ */ __name(function BrandingConfigComponent_Conditional_102_Template_input_input_31_listener($event) {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.deleteConfirmation.set($event.target.value));
    }, "BrandingConfigComponent_Conditional_102_Template_input_input_31_listener"));
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function BrandingConfigComponent_Conditional_102_Template_button_click_34_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.hideDeleteModal());
    }, "BrandingConfigComponent_Conditional_102_Template_button_click_34_listener"));
    \u0275\u0275text(35, " Cancelar ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "button", 81);
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function BrandingConfigComponent_Conditional_102_Template_button_click_36_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.deleteCompany());
    }, "BrandingConfigComponent_Conditional_102_Template_button_click_36_listener"));
...
__name(BrandingConfigComponent_Conditional_102_Template, "BrandingConfigComponent_Conditional_102_Template");
var _BrandingConfigComponent = class _BrandingConfigComponent {
...
__publicField(_BrandingConfigComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BrandingConfigComponent, selectors: [["app-branding-config"]], decls: 103, vars: 36, consts: [["logoInput", ""], ["title", "Minha Empresa"], [1, "bg-green-500", "hover:bg-green-600", "text-white", "px-4", "py-2", "rounded-lg", "text-sm", "font-medium", "transition-colors", 3, "click", "disabled"], [1, "max-w-7xl", "mx-auto", "px-4", "sm:px-6", "lg:px-8", "py-8"], [1, "mb-6", "p-4", "bg-green-50", "border", "border-green-200", "rounded-lg", "text-green-800"], [1, "mb-6", "p-4", "bg-red-50", "border", "border-red-200", "rounded-lg", "text-red-800"], [1, "bg-white", "rounded-lg", "shadow-sm", "border", "border-gray-200", "mb-8"], [1, "p-6", "border-b", "border-gray-200"], [1, "text-lg", "font-semibold", "text-gray-900", "flex", "items-center"], [1, "fas", "fa-eye", "text-blue-500", "mr-2"], [1, "text-sm", "text-gray-600", "mt-1"], [1, "p-6"], [1, "border", "border-gray-300", "rounded-lg", "p-6", "bg-gray-50"], [1, "flex", "items-center", "justify-between", "p-4", "bg-white", "rounded", "border", "border-gray-200", "mb-4"], [1, "flex", "items-center", "space-x-3"], ["alt", "Logo Preview", 1, "h-8", "w-auto", 3, "src"], [1, "h-8", "w-8", "bg-gray-300", "rounded", "flex", "items-center", "justify-center"], [1, "text-lg", "font-semibold"], [1, "flex", "space-x-2"], [1, "px-3", "py-1", "rounded", "text-sm", "font-medium"], [1, "px-3", "py-1", "rounded", "text-sm", "font-medium", "text-white"], [1, "bg-white", "rounded", "border", "border-gray-200", "p-4"], [1, "font-semibold", "mb-2"], [1, "text-gray-600", "text-sm", "mb-3"], [1, "px-2", "py-1", "rounded", "text-xs", "font-medium"], [1, "grid", "grid-cols-1", "lg:grid-cols-2", "gap-8"], [1, "bg-white", "rounded-lg", "shadow-sm", "border", "border-gray-200"], [1, "fas", "fa-image", "text-blue-500", "mr-2"], [1, "mb-6"], [1, "border-2", "border-dashed", "border-gray-300", "rounded-lg", "p-8", "text-center", "hover:border-blue-400", "transition-colors", "cursor-pointer", 3, "click"], ["type", "file", "accept", "image/*", 1, "hidden", 3, "change"], [1, "space-y-3"], [1, "block", "text-sm", "font-medium", "text-gray-700", "mb-1"], ["type", "url", "placeholder", "https://exemplo.com/logo.png", 1, "w-full", "px-3", "py-2", "border", "border-gray-300", "rounded-md", "focus:ring-blue-500", "focus:border-blue-500", 3, "ngModelChange", "input", "ngModel"], [1, "w-full", "bg-red-500", "hover:bg-red-600", "text-white", "px-4", "py-2", "rounded-md", "text-sm", "font-medium", "transition-colors"], [1, "fas", "fa-palette", "text-blue-500", "mr-2"], [1, "p-6", "space-y-4"], [1, "block", "text-sm", "font-medium", "text-gray-700", "mb-2"], [1, "flex", "space-x-3"], ["type", "color", 1, "w-12", "h-10", "border", "border-gray-300", "rounded", "cursor-pointer", 3, "input", "value"], ["type", "text", "placeholder", "#3B82F6", 1, "flex-1", "px-3", "py-2", "border", "border-gray-300", "rounded-md", "focus:ring-blue-500", "focus:border-blue-500", 3, "input", "value"], [1, "text-xs", "text-gray-500", "mt-1"], ["type", "text", "placeholder", "#6B7280", 1, "flex-1", "px-3", "py-2", "border", "border-gray-300", "rounded-md", "focus:ring-blue-500", "focus:border-blue-500", 3, "input", "value"], [1, "flex", "space-x-2", "flex-wrap", "gap-2"], ["type", "button", 1, "w-8", "h-8", "rounded-full", "border-2", "border-white", "shadow-sm", "hover:scale-110", "transition-transform", 3, "background-color", "title"], [1, "pt-4", "border-t", "border-gray-200"], ["type", "button", 1, "w-full", "bg-gray-500", "hover:bg-gray-600", "text-white", "px-4", "py-2", "rounded-md", "text-sm", "font-medium", "transition-colors", 3, "click"], [1, "fas", "fa-undo", "mr-1"], [1, "mt-8", "bg-white", "rounded-lg", "shadow-sm", "border", "border-gray-200"], [1, "fas", "fa-building", "text-blue-500", "mr-2"], ["type", "text", "placeholder", "Nome da sua empresa", 1, "w-full", "px-3", "py-2", "border", "border-gray-300", "rounded-md", "focus:ring-blue-500", "focus:border-blue-500", 3, "ngModelChange", "input", "ngModel"], [1, "mt-8", "bg-white", "rounded-lg", "shadow-sm", "border", "border-red-200"], [1, "fixed", "inset-0", "bg-gray-600", "bg-opacity-50", "overflow-y-auto", "h-full", "w-full", "z-50"], [1, "fas", "fa-spinner", "fa-spin", "mr-1"], [1, "fas", "fa-save", "mr-1"], [1, "fas", "fa-check-circle", "mr-2"], [1, "fas", "fa-exclamation-circle", "mr-2"], [1, "fas", "fa-image", "text-gray-500"], ["alt", "Logo atual", 1, "max-h-20", "mx-auto", "mb-4", 3, "src"], [1, "text-sm", "text-gray-600"], [1, "fas", "fa-cloud-upload-alt", "text-4xl", "text-gray-400", "mb-4"], [1, "w-full", "bg-red-500", "hover:bg-red-600", "text-white", "px-4", "py-2", "rounded-md", "text-sm", "font-medium", "transition-colors", 3, "click"], [1, "fas", "fa-trash", "mr-1"], ["type", "button", 1, "w-8", "h-8", "rounded-full", "border-2", "border-white", "shadow-sm", "hover:scale-110", "transition-transform", 3, "click", "title"], [1, "p-6", "bg-red-50", "rounded-t-lg", "border-b", "border-red-200"], [1, "text-lg", "font-semibold", "text-red-800", "flex", "items-center"], [1, "fas", "fa-exclamation-triangle", "mr-2"], [1, "text-sm", "text-red-700", "mt-1"], [1, "bg-red-600", "hover:bg-red-700", "text-white", "px-4", "py-2", "rounded-md", "text-sm", "font-medium", "transition-colors", 3, "click"], [1, "relative", "top-20", "mx-auto", "p-5", "border", "w-96", "shadow-lg", "rounded-md", "bg-white"], [1, "mt-3"], [1, "flex", "items-center", "justify-between", "mb-4"], [1, "fas", "fa-exclamation-triangle", "text-red-500", "mr-2"], [1, "text-gray-400", "hover:text-gray-600", 3, "click"], [1, "fas", "fa-times"], [1, "mb-4", "p-3", "bg-red-50", "border", "border-red-200", "rounded"], [1, "text-sm", "text-gray-600", "mb-4"], [1, "text-sm", "text-gray-600", "mb-4", "list-disc", "list-inside"], ["type", "text", "placeholder", "Nome da empresa", 1, "w-full", "px-3", "py-2", "border", "border-gray-300", "rounded-md", "focus:ring-red-500", "focus:border-red-500", "mb-4", 3, "ngModelChange", "input", "ngModel", "value"], [1, "mb-4", "p-3", "bg-red-50", "border", "border-red-200", "rounded", "text-red-800"], [1, "flex-1", "bg-gray-500", "hover:bg-gray-600", "text-white", "px-4", "py-2", "rounded-md", "text-sm", "font-medium", "transition-colors", 3, "click", "disabled"], [1, "flex-1", "bg-red-600", "hover:bg-red-700", "text-white", "px-4", "py-2", "rounded-md", "text-sm", "font-medium", "transition-colors", 3, "click", "disabled"]], template: /* @__PURE__ */ __name(function BrandingConfigComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function BrandingConfigComponent_Template_div_click_46_listener() {
      \u0275\u0275restoreView(_r1);
      const logoInput_r3 = \u0275\u0275reference(50);
      return \u0275\u0275resetView(logoInput_r3.click());
    }, "BrandingConfigComponent_Template_div_click_46_listener"));
    ...
    \u0275\u0275listener("change", /* @__PURE__ */ __name(function BrandingConfigComponent_Template_input_change_49_listener($event) {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.onLogoSelected($event));
    }, "BrandingConfigComponent_Template_input_change_49_listener"));
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(51, "div", 31)(52, "div")(53, "label", 32);
    \u0275\u0275text(54, "URL do Logo (opcional)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(55, "input", 33);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function BrandingConfigComponent_Template_input_ngModelChange_55_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.logoUrl, $event) || (ctx.logoUrl = $event);
      return \u0275\u0275resetView($event);
    }, "BrandingConfigComponent_Template_input_ngModelChange_55_listener"));
    \u0275\u0275listener("input", /* @__PURE__ */ __name(function BrandingConfigComponent_Template_input_input_55_listener($event) {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.logoUrl.set($event.target.value));
    }, "BrandingConfigComponent_Template_input_input_55_listener"));
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275listener("input", /* @__PURE__ */ __name(function BrandingConfigComponent_Template_input_input_67_listener($event) {
      \u0275\u0275restoreView(_r1);
      ctx.primaryColor.set($event.target.value);
      return \u0275\u0275resetView(ctx.applyPreviewColors());
    }, "BrandingConfigComponent_Template_input_input_67_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(68, "input", 40);
    \u0275\u0275listener("input", /* @__PURE__ */ __name(function BrandingConfigComponent_Template_input_input_68_listener($event) {
      \u0275\u0275restoreView(_r1);
      ctx.primaryColor.set($event.target.value);
      return \u0275\u0275resetView(ctx.applyPreviewColors());
    }, "BrandingConfigComponent_Template_input_input_68_listener"));
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275listener("input", /* @__PURE__ */ __name(function BrandingConfigComponent_Template_input_input_75_listener($event) {
      \u0275\u0275restoreView(_r1);
      ctx.secondaryColor.set($event.target.value);
      return \u0275\u0275resetView(ctx.applyPreviewColors());
    }, "BrandingConfigComponent_Template_input_input_75_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(76, "input", 42);
    \u0275\u0275listener("input", /* @__PURE__ */ __name(function BrandingConfigComponent_Template_input_input_76_listener($event) {
      \u0275\u0275restoreView(_r1);
      ctx.secondaryColor.set($event.target.value);
      return \u0275\u0275resetView(ctx.applyPreviewColors());
    }, "BrandingConfigComponent_Template_input_input_76_listener"));
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function BrandingConfigComponent_Template_button_click_86_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.resetColors());
    }, "BrandingConfigComponent_Template_button_click_86_listener"));
    \u0275\u0275element(87, "i", 47);
    ...
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function BrandingConfigComponent_Template_input_ngModelChange_98_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.companyName, $event) || (ctx.companyName = $event);
      return \u0275\u0275resetView($event);
    }, "BrandingConfigComponent_Template_input_ngModelChange_98_listener"));
    \u0275\u0275listener("input", /* @__PURE__ */ __name(function BrandingConfigComponent_Template_input_input_98_listener($event) {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.companyName.set($event.target.value));
    }, "BrandingConfigComponent_Template_input_input_98_listener"));
    \u0275\u0275elementEnd();
...
}, "BrandingConfigComponent_Template"), dependencies: [CommonModule, FormsModule, DefaultValueAccessor, NgControlStatus, NgModel, ConfigHeaderComponent, MainLayoutComponent], styles: ["\n\n[_nghost-%COMP%] {\n  display: block;\n}\n/*# sourceMappingURL=branding-config.component.css.map */"] }));
var BrandingConfigComponent = _BrandingConfigComponent;
(() => {
...
//# sourceMappingURL=chunk-64LFOVXW.js.map
