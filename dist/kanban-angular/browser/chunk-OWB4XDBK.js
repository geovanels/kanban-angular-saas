import{b}from"./chunk-ZBJHR7UR.js";import{F as C,I as h}from"./chunk-OUCFDODB.js";import{K as u,a as g,aa as y,f as c,fa as l,m,w as s,z as d}from"./chunk-HM7IHYI7.js";var v=class p{http=l(b);subdomainService=l(C);companyService=l(h);brandingSubject=new m({});branding$=this.brandingSubject.asObservable();constructor(){this.initializeBranding();try{this.subdomainService.currentCompany$.subscribe(r=>{r&&this.applyCompanyBranding(r)})}catch{}setTimeout(()=>{this.applyStoredBranding()},100)}initializeBranding(){let r=this.subdomainService.getCurrentCompany();r&&this.updateBranding({logoUrl:r.logoUrl,primaryColor:r.brandingConfig?.primaryColor||r.primaryColor,secondaryColor:r.brandingConfig?.secondaryColor||r.secondaryColor})}applyStoredBranding(){let r=this.subdomainService.getCurrentCompany();r&&r.brandingConfig&&r.brandingConfig.primaryColor&&this.applyColors({primaryColor:r.brandingConfig.primaryColor,secondaryColor:r.brandingConfig.secondaryColor})}uploadLogo(r){let o=this.subdomainService.getCurrentCompany();if(!o)return s(()=>new Error("Empresa n\xE3o encontrada"));let e=this.validateImageFile(r);if(e)return s(()=>new Error(e));let n=new FormData;n.append("logo",r),n.append("companyId",o.id);let a=`${this.subdomainService.getApiUrl()}/upload/logo`;return this.http.post(a,n).pipe(d(t=>(t.success&&t.logoUrl&&this.updateCompanyLogo(t.logoUrl),t)),u(t=>(console.error("Erro ao fazer upload do logo:",t),s(()=>({success:!1,error:t.error?.message||"Erro ao fazer upload do logo"})))))}uploadFavicon(r){let o=this.subdomainService.getCurrentCompany();if(!o)return s(()=>new Error("Empresa n\xE3o encontrada"));let e=this.validateFaviconFile(r);if(e)return s(()=>new Error(e));let n=new FormData;n.append("favicon",r),n.append("companyId",o.id);let a=`${this.subdomainService.getApiUrl()}/upload/favicon`;return this.http.post(a,n).pipe(d(t=>(t.success&&t.logoUrl&&this.applyFavicon(t.logoUrl),t)),u(t=>(console.error("Erro ao fazer upload do favicon:",t),s(()=>t))))}updateColors(r){return c(this,null,function*(){let o=this.subdomainService.getCurrentCompany();if(!o)throw new Error("Empresa n\xE3o encontrada");try{yield this.companyService.updateCompany(o.id,r),Object.assign(o,r),this.subdomainService.setCurrentCompany(o),this.applyColors(r),this.updateBranding(r)}catch(e){throw console.error("Erro ao atualizar cores:",e),e}})}applyCustomCss(r){if(this.removeCustomCss(),r.trim()){let o=document.createElement("style");o.id="company-custom-css",o.textContent=r,document.head.appendChild(o)}}removeCustomCss(){let r=document.getElementById("company-custom-css");r&&r.remove()}applyCompanyBranding(r){let o=r.brandingConfig?.primaryColor||r.primaryColor,e=r.brandingConfig?.secondaryColor||r.secondaryColor,n={logoUrl:r.logoUrl,primaryColor:o,secondaryColor:e};this.updateBranding(n),(o||e)&&this.applyColors({primaryColor:o,secondaryColor:e}),this.updatePageTitle(r.name)}generateColorPalette(r){let o=r.replace("#",""),e=parseInt(o.substr(0,2),16),n=parseInt(o.substr(2,2),16),a=parseInt(o.substr(4,2),16);return{primary:r,primaryLight:this.lightenColor(r,20),primaryDark:this.darkenColor(r,20),secondary:this.adjustHue(r,30),accent:this.adjustHue(r,-30),success:"#28a745",warning:"#ffc107",danger:"#dc3545",info:"#17a2b8"}}validateImageFile(r){return r.size>5242880?"Arquivo muito grande. Tamanho m\xE1ximo: 5MB":["image/jpeg","image/jpg","image/png","image/svg+xml"].includes(r.type)?null:"Tipo de arquivo n\xE3o suportado. Use JPEG, PNG ou SVG"}validateFaviconFile(r){return r.size>1048576?"Arquivo muito grande. Tamanho m\xE1ximo: 1MB":["image/x-icon","image/vnd.microsoft.icon","image/png"].includes(r.type)?null:"Tipo de arquivo n\xE3o suportado. Use ICO ou PNG"}updateCompanyLogo(r){return c(this,null,function*(){let o=this.subdomainService.getCurrentCompany();o&&(o.logoUrl=r,this.subdomainService.setCurrentCompany(o),yield this.companyService.updateCompany(o.id,{logoUrl:r}),this.updateBranding({logoUrl:r}))})}applyColors(r){let o=document.documentElement;if(r.primaryColor){let e=this.generateColorPalette(r.primaryColor);Object.entries(e).forEach(([n,a])=>{o.style.setProperty(`--color-${n}`,a)}),o.style.setProperty("--bs-primary",r.primaryColor),o.style.setProperty("--primary-color",r.primaryColor),o.style.setProperty("--tw-ring-color",r.primaryColor+"66")}r.secondaryColor&&(o.style.setProperty("--color-secondary",r.secondaryColor),o.style.setProperty("--bs-secondary",r.secondaryColor),o.style.setProperty("--secondary-color",r.secondaryColor)),r.accentColor&&o.style.setProperty("--color-accent",r.accentColor),this.applyDynamicStyles(r)}applyDynamicStyles(r){if(!r.primaryColor)return;let o=document.getElementById("dynamic-branding-styles");o&&o.remove();let e=document.createElement("style");e.id="dynamic-branding-styles",e.textContent=`
