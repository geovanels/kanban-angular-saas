...
__name(_assertInstanceOf, "_assertInstanceOf");
...
var _FetchProvider = class _FetchProvider {
...
__name(_FetchProvider, "FetchProvider");
var FetchProvider = _FetchProvider;
...
var _NetworkTimeout = class _NetworkTimeout {
  clearNetworkTimeout() {
...
__name(_NetworkTimeout, "NetworkTimeout");
...
var _RecaptchaConfig = class _RecaptchaConfig {
...
__name(_RecaptchaConfig, "RecaptchaConfig");
var RecaptchaConfig = _RecaptchaConfig;
...
__name(getRecaptchaParams, "getRecaptchaParams");
...
var _ProactiveRefresh = class _ProactiveRefresh {
  constructor(user) {
    this.user = user;
...
__name(_ProactiveRefresh, "ProactiveRefresh");
var ProactiveRefresh = _ProactiveRefresh;
var _UserMetadata = class _UserMetadata {
...
__name(_UserMetadata, "UserMetadata");
var UserMetadata = _UserMetadata;
...
var _StsTokenManager = class _StsTokenManager {
  constructor() {
...
__name(_StsTokenManager, "StsTokenManager");
var StsTokenManager = _StsTokenManager;
function assertStringOrUndefined(assertion, appName) {
  _assert(typeof assertion === "string" || typeof assertion === "undefined", "internal-error", { appName });
}
__name(assertStringOrUndefined, "assertStringOrUndefined");
var _UserImpl = class _UserImpl {
  constructor(_a) {
...
__name(_UserImpl, "UserImpl");
var UserImpl = _UserImpl;
...
var _InMemoryPersistence = class _InMemoryPersistence {
  constructor() {
    this.type = "NONE";
    this.storage = {};
  }
...
__name(_InMemoryPersistence, "InMemoryPersistence");
var InMemoryPersistence = _InMemoryPersistence;
...
var _PersistenceUserManager = class _PersistenceUserManager {
...
__name(_PersistenceUserManager, "PersistenceUserManager");
var PersistenceUserManager = _PersistenceUserManager;
...
var _AuthMiddlewareQueue = class _AuthMiddlewareQueue {
  constructor(auth) {
    this.auth = auth;
    this.queue = [];
  }
...
__name(_AuthMiddlewareQueue, "AuthMiddlewareQueue");
var AuthMiddlewareQueue = _AuthMiddlewareQueue;
...
var _PasswordPolicyImpl = class _PasswordPolicyImpl {
  constructor(response) {
    var _a, _b, _c, _d;
...
__name(_PasswordPolicyImpl, "PasswordPolicyImpl");
var PasswordPolicyImpl = _PasswordPolicyImpl;
var _AuthImpl = class _AuthImpl {
...
__name(_AuthImpl, "AuthImpl");
var AuthImpl = _AuthImpl;
...
__name(_recaptchaV2ScriptUrl, "_recaptchaV2ScriptUrl");
...
var _MockReCaptcha = class _MockReCaptcha {
  constructor(auth) {
    this.auth = auth;
...
__name(_MockReCaptcha, "MockReCaptcha");
var MockReCaptcha = _MockReCaptcha;
var _MockGreCAPTCHATopLevel = class _MockGreCAPTCHATopLevel {
  constructor() {
...
__name(_MockGreCAPTCHATopLevel, "MockGreCAPTCHATopLevel");
var MockGreCAPTCHATopLevel = _MockGreCAPTCHATopLevel;
var _MockGreCAPTCHA = class _MockGreCAPTCHA {
  ready(callback) {
    callback();
  }
  execute(_siteKey, _options) {
...
__name(_MockGreCAPTCHA, "MockGreCAPTCHA");
var MockGreCAPTCHA = _MockGreCAPTCHA;
var _MockWidget = class _MockWidget {
...
__name(_MockWidget, "MockWidget");
var MockWidget = _MockWidget;
...
__name(generateRandomAlphaNumericString, "generateRandomAlphaNumericString");
var RECAPTCHA_ENTERPRISE_VERIFIER_TYPE = "recaptcha-enterprise";
var FAKE_TOKEN = "NO_RECAPTCHA";
var _RecaptchaEnterpriseVerifier = class _RecaptchaEnterpriseVerifier {
  /**
   *
...
__name(_RecaptchaEnterpriseVerifier, "RecaptchaEnterpriseVerifier");
var RecaptchaEnterpriseVerifier = _RecaptchaEnterpriseVerifier;
...
var _AuthCredential = class _AuthCredential {
  /** @internal */
...
__name(_AuthCredential, "AuthCredential");
var AuthCredential = _AuthCredential;
...
var _EmailAuthCredential = class _EmailAuthCredential extends AuthCredential {
  /** @internal */
...
__name(_EmailAuthCredential, "EmailAuthCredential");
var EmailAuthCredential = _EmailAuthCredential;
...
var _OAuthCredential = class _OAuthCredential extends AuthCredential {
  constructor() {
    super(...arguments);
...
__name(_OAuthCredential, "OAuthCredential");
var OAuthCredential = _OAuthCredential;
...
var _PhoneAuthCredential = class _PhoneAuthCredential extends AuthCredential {
  constructor(params) {
    super(
      "phone",
      "phone"
...
__name(_PhoneAuthCredential, "PhoneAuthCredential");
var PhoneAuthCredential = _PhoneAuthCredential;
...
var _ActionCodeURL = class _ActionCodeURL {
  /**
...
__name(_ActionCodeURL, "ActionCodeURL");
var ActionCodeURL = _ActionCodeURL;
function parseActionCodeURL(link) {
  return ActionCodeURL.parseLink(link);
}
__name(parseActionCodeURL, "parseActionCodeURL");
var _EmailAuthProvider = class _EmailAuthProvider {
  constructor() {
...
__name(_EmailAuthProvider, "EmailAuthProvider");
var EmailAuthProvider = _EmailAuthProvider;
EmailAuthProvider.PROVIDER_ID = "password";
EmailAuthProvider.EMAIL_PASSWORD_SIGN_IN_METHOD = "password";
EmailAuthProvider.EMAIL_LINK_SIGN_IN_METHOD = "emailLink";
var _FederatedAuthProvider = class _FederatedAuthProvider {
  /**
...
__name(_FederatedAuthProvider, "FederatedAuthProvider");
var FederatedAuthProvider = _FederatedAuthProvider;
var _BaseOAuthProvider = class _BaseOAuthProvider extends FederatedAuthProvider {
  constructor() {
    super(...arguments);
    this.scopes = [];
  }
...
__name(_BaseOAuthProvider, "BaseOAuthProvider");
var BaseOAuthProvider = _BaseOAuthProvider;
var _OAuthProvider = class _OAuthProvider extends BaseOAuthProvider {
  /**
...
__name(_OAuthProvider, "OAuthProvider");
var OAuthProvider = _OAuthProvider;
var _FacebookAuthProvider = class _FacebookAuthProvider extends BaseOAuthProvider {
  constructor() {
    super(
      "facebook.com"
      /* ProviderId.FACEBOOK */
...
__name(_FacebookAuthProvider, "FacebookAuthProvider");
var FacebookAuthProvider = _FacebookAuthProvider;
FacebookAuthProvider.FACEBOOK_SIGN_IN_METHOD = "facebook.com";
FacebookAuthProvider.PROVIDER_ID = "facebook.com";
var _GoogleAuthProvider = class _GoogleAuthProvider extends BaseOAuthProvider {
  constructor() {
    super(
      "google.com"
      /* ProviderId.GOOGLE */
...
__name(_GoogleAuthProvider, "GoogleAuthProvider");
var GoogleAuthProvider = _GoogleAuthProvider;
GoogleAuthProvider.GOOGLE_SIGN_IN_METHOD = "google.com";
GoogleAuthProvider.PROVIDER_ID = "google.com";
var _GithubAuthProvider = class _GithubAuthProvider extends BaseOAuthProvider {
  constructor() {
    super(
      "github.com"
      /* ProviderId.GITHUB */
...
__name(_GithubAuthProvider, "GithubAuthProvider");
var GithubAuthProvider = _GithubAuthProvider;
GithubAuthProvider.GITHUB_SIGN_IN_METHOD = "github.com";
GithubAuthProvider.PROVIDER_ID = "github.com";
var IDP_REQUEST_URI = "http://localhost";
var _SAMLAuthCredential = class _SAMLAuthCredential extends AuthCredential {
  /** @internal */
...
__name(_SAMLAuthCredential, "SAMLAuthCredential");
var SAMLAuthCredential = _SAMLAuthCredential;
var SAML_PROVIDER_PREFIX = "saml.";
var _SAMLAuthProvider = class _SAMLAuthProvider extends FederatedAuthProvider {
  /**
...
__name(_SAMLAuthProvider, "SAMLAuthProvider");
var SAMLAuthProvider = _SAMLAuthProvider;
var _TwitterAuthProvider = class _TwitterAuthProvider extends BaseOAuthProvider {
  constructor() {
    super(
      "twitter.com"
      /* ProviderId.TWITTER */
...
__name(_TwitterAuthProvider, "TwitterAuthProvider");
var TwitterAuthProvider = _TwitterAuthProvider;
...
var _UserCredentialImpl = class _UserCredentialImpl {
  constructor(params) {
...
__name(_UserCredentialImpl, "UserCredentialImpl");
var UserCredentialImpl = _UserCredentialImpl;
...
var _MultiFactorError = class _MultiFactorError extends FirebaseError {
...
__name(_MultiFactorError, "MultiFactorError");
var MultiFactorError = _MultiFactorError;
...
var _MultiFactorInfoImpl = class _MultiFactorInfoImpl {
...
__name(_MultiFactorInfoImpl, "MultiFactorInfoImpl");
var MultiFactorInfoImpl = _MultiFactorInfoImpl;
var _PhoneMultiFactorInfoImpl = class _PhoneMultiFactorInfoImpl extends MultiFactorInfoImpl {
  constructor(response) {
...
__name(_PhoneMultiFactorInfoImpl, "PhoneMultiFactorInfoImpl");
var PhoneMultiFactorInfoImpl = _PhoneMultiFactorInfoImpl;
var _TotpMultiFactorInfoImpl = class _TotpMultiFactorInfoImpl extends MultiFactorInfoImpl {
  constructor(response) {
    super("totp", response);
  }
  static _fromServerResponse(_auth, enrollment) {
...
__name(_TotpMultiFactorInfoImpl, "TotpMultiFactorInfoImpl");
var TotpMultiFactorInfoImpl = _TotpMultiFactorInfoImpl;
...
var _GenericAdditionalUserInfo = class _GenericAdditionalUserInfo {
...
__name(_GenericAdditionalUserInfo, "GenericAdditionalUserInfo");
var GenericAdditionalUserInfo = _GenericAdditionalUserInfo;
var _FederatedAdditionalUserInfoWithUsername = class _FederatedAdditionalUserInfoWithUsername extends GenericAdditionalUserInfo {
  constructor(isNewUser, providerId, profile, username) {
    super(isNewUser, providerId, profile);
    this.username = username;
  }
};
__name(_FederatedAdditionalUserInfoWithUsername, "FederatedAdditionalUserInfoWithUsername");
var FederatedAdditionalUserInfoWithUsername = _FederatedAdditionalUserInfoWithUsername;
var _FacebookAdditionalUserInfo = class _FacebookAdditionalUserInfo extends GenericAdditionalUserInfo {
  constructor(isNewUser, profile) {
    super(isNewUser, "facebook.com", profile);
  }
};
__name(_FacebookAdditionalUserInfo, "FacebookAdditionalUserInfo");
var FacebookAdditionalUserInfo = _FacebookAdditionalUserInfo;
var _GithubAdditionalUserInfo = class _GithubAdditionalUserInfo extends FederatedAdditionalUserInfoWithUsername {
  constructor(isNewUser, profile) {
    super(isNewUser, "github.com", profile, typeof (profile === null || profile === void 0 ? void 0 : profile.login) === "string" ? profile === null || profile === void 0 ? void 0 : profile.login : null);
  }
};
__name(_GithubAdditionalUserInfo, "GithubAdditionalUserInfo");
var GithubAdditionalUserInfo = _GithubAdditionalUserInfo;
var _GoogleAdditionalUserInfo = class _GoogleAdditionalUserInfo extends GenericAdditionalUserInfo {
  constructor(isNewUser, profile) {
    super(isNewUser, "google.com", profile);
  }
};
__name(_GoogleAdditionalUserInfo, "GoogleAdditionalUserInfo");
var GoogleAdditionalUserInfo = _GoogleAdditionalUserInfo;
var _TwitterAdditionalUserInfo = class _TwitterAdditionalUserInfo extends FederatedAdditionalUserInfoWithUsername {
  constructor(isNewUser, profile, screenName) {
    super(isNewUser, "twitter.com", profile, screenName);
  }
};
__name(_TwitterAdditionalUserInfo, "TwitterAdditionalUserInfo");
var TwitterAdditionalUserInfo = _TwitterAdditionalUserInfo;
...
var _MultiFactorSessionImpl = class _MultiFactorSessionImpl {
...
__name(_MultiFactorSessionImpl, "MultiFactorSessionImpl");
var MultiFactorSessionImpl = _MultiFactorSessionImpl;
var _MultiFactorResolverImpl = class _MultiFactorResolverImpl {
...
__name(_MultiFactorResolverImpl, "MultiFactorResolverImpl");
var MultiFactorResolverImpl = _MultiFactorResolverImpl;
...
var _MultiFactorUserImpl = class _MultiFactorUserImpl {
  constructor(user) {
    this.user = user;
...
__name(_MultiFactorUserImpl, "MultiFactorUserImpl");
var MultiFactorUserImpl = _MultiFactorUserImpl;
...
var _BrowserPersistenceClass = class _BrowserPersistenceClass {
...
__name(_BrowserPersistenceClass, "BrowserPersistenceClass");
var BrowserPersistenceClass = _BrowserPersistenceClass;
var _POLLING_INTERVAL_MS$1 = 1e3;
var IE10_LOCAL_STORAGE_SYNC_DELAY = 10;
var _BrowserLocalPersistence = class _BrowserLocalPersistence extends BrowserPersistenceClass {
  constructor() {
    super(
      () => window.localStorage,
      "LOCAL"
...
__name(_BrowserLocalPersistence, "BrowserLocalPersistence");
var BrowserLocalPersistence = _BrowserLocalPersistence;
...
var _CookiePersistence = class _CookiePersistence {
  constructor() {
    this.type = "COOKIE";
  ...
  _addListener(key, listener) {
    ...
    if (window.cookieStore) {
      ...
      const unsubscribe2 = /* @__PURE__ */ __name(() => window.cookieStore.removeEventListener("change", cb), "unsubscribe");
    ...
    const unsubscribe = /* @__PURE__ */ __name(() => clearInterval(interval), "unsubscribe");
...
__name(_CookiePersistence, "CookiePersistence");
var CookiePersistence = _CookiePersistence;
CookiePersistence.type = "COOKIE";
var browserCookiePersistence = CookiePersistence;
var _BrowserSessionPersistence = class _BrowserSessionPersistence extends BrowserPersistenceClass {
  constructor() {
    super(
...
__name(_BrowserSessionPersistence, "BrowserSessionPersistence");
var BrowserSessionPersistence = _BrowserSessionPersistence;
...
var _DBPromise = class _DBPromise {
  constructor(request) {
...
__name(_DBPromise, "DBPromise");
var DBPromise = _DBPromise;
...
var _IndexedDBLocalPersistence = class _IndexedDBLocalPersistence {
  constructor() {
    this.type = "LOCAL";
    this._shouldAllowMigration = true;
    this.listeners = {};
...
__name(_IndexedDBLocalPersistence, "IndexedDBLocalPersistence");
var IndexedDBLocalPersistence = _IndexedDBLocalPersistence;
...
var _ReCaptchaLoaderImpl = class _ReCaptchaLoaderImpl {
  constructor() {
    var _a;
    this.hostLanguage = "";
    this.counter = 0;
...
__name(_ReCaptchaLoaderImpl, "ReCaptchaLoaderImpl");
var ReCaptchaLoaderImpl = _ReCaptchaLoaderImpl;
function isHostLanguageValid(hl) {
  return hl.length <= 6 && /^\s*[a-zA-Z0-9\-]*\s*$/.test(hl);
}
__name(isHostLanguageValid, "isHostLanguageValid");
var _MockReCaptchaLoaderImpl = class _MockReCaptchaLoaderImpl {
  load(auth) {
    return __async(this, null, function* () {
...
__name(_MockReCaptchaLoaderImpl, "MockReCaptchaLoaderImpl");
var MockReCaptchaLoaderImpl = _MockReCaptchaLoaderImpl;
var RECAPTCHA_VERIFIER_TYPE = "recaptcha";
var DEFAULT_PARAMS = {
  theme: "light",
  type: "image"
};
var _RecaptchaVerifier = class _RecaptchaVerifier {
  /**
   * @param authExtern - The corresponding Firebase {@link Auth} instance.
   *
  ...
  verify() {
    return __async(this, null, function* () {
      ...
      return new Promise((resolve) => {
        const tokenChange = /* @__PURE__ */ __name((token) => {
          if (!token) {
            return;
          }
...
__name(_RecaptchaVerifier, "RecaptchaVerifier");
var RecaptchaVerifier = _RecaptchaVerifier;
function domReady() {
  let resolver = null;
  return new Promise((resolve) => {
    ...
    resolver = /* @__PURE__ */ __name(() => resolve(), "resolver");
...
var _ConfirmationResultImpl = class _ConfirmationResultImpl {
...
__name(_ConfirmationResultImpl, "ConfirmationResultImpl");
var ConfirmationResultImpl = _ConfirmationResultImpl;
...
__name(signInWithPhoneNumber, "signInWithPhoneNumber");
...
__name(linkWithPhoneNumber, "linkWithPhoneNumber");
...
__name(reauthenticateWithPhoneNumber, "reauthenticateWithPhoneNumber");
    ...
    try {
      ...
      if ("session" in phoneInfoOptions) {
        ...
        if ("phoneNumber" in phoneInfoOptions) {
          ...
          const startEnrollPhoneMfaActionCallback = /* @__PURE__ */ __name((authInstance, request) => __async(null, null, function* () {
          ...
          const startSignInPhoneMfaActionCallback = /* @__PURE__ */ __name((authInstance, request) => __async(null, null, function* () {
        ...
        const sendPhoneVerificationCodeActionCallback = /* @__PURE__ */ __name((authInstance, request) => __async(null, null, function* () {
...
__name(updatePhoneNumber, "updatePhoneNumber");
...
var _PhoneAuthProvider = class _PhoneAuthProvider {
  /**
...
__name(_PhoneAuthProvider, "PhoneAuthProvider");
var PhoneAuthProvider = _PhoneAuthProvider;
...
var _IdpCredential = class _IdpCredential extends AuthCredential {
  constructor(params) {
    super(
      "custom",
      "custom"
...
__name(_IdpCredential, "IdpCredential");
var IdpCredential = _IdpCredential;
...
__name(_link, "_link");
var _AbstractPopupRedirectOperation = class _AbstractPopupRedirectOperation {
...
__name(_AbstractPopupRedirectOperation, "AbstractPopupRedirectOperation");
var AbstractPopupRedirectOperation = _AbstractPopupRedirectOperation;
...
__name(signInWithPopup, "signInWithPopup");
...
__name(reauthenticateWithPopup, "reauthenticateWithPopup");
...
__name(linkWithPopup, "linkWithPopup");
var _PopupOperation = class _PopupOperation extends AbstractPopupRedirectOperation {
...
__name(_PopupOperation, "PopupOperation");
var PopupOperation = _PopupOperation;
PopupOperation.currentPopupAction = null;
var PENDING_REDIRECT_KEY = "pendingRedirect";
var redirectOutcomeMap = /* @__PURE__ */ new Map();
var _RedirectAction = class _RedirectAction extends AbstractPopupRedirectOperation {
    ...
    return __async(this, null, function* () {
      ...
      if (!readyOutcome) {
        try {
          ...
          readyOutcome = /* @__PURE__ */ __name(() => Promise.resolve(result), "readyOutcome");
        } catch (e) {
          readyOutcome = /* @__PURE__ */ __name(() => Promise.reject(e), "readyOutcome");
        }
...
__name(_RedirectAction, "RedirectAction");
var RedirectAction = _RedirectAction;
...
__name(_setPendingRedirectStatus, "_setPendingRedirectStatus");
...
__name(signInWithRedirect, "signInWithRedirect");
...
__name(_signInWithRedirect, "_signInWithRedirect");
function reauthenticateWithRedirect(user, provider, resolver) {
  return _reauthenticateWithRedirect(user, provider, resolver);
}
__name(reauthenticateWithRedirect, "reauthenticateWithRedirect");
...
__name(_reauthenticateWithRedirect, "_reauthenticateWithRedirect");
function linkWithRedirect(user, provider, resolver) {
  return _linkWithRedirect(user, provider, resolver);
}
__name(linkWithRedirect, "linkWithRedirect");
...
__name(_linkWithRedirect, "_linkWithRedirect");
...
__name(prepareUserForRedirect, "prepareUserForRedirect");
var EVENT_DUPLICATION_CACHE_DURATION_MS = 10 * 60 * 1e3;
var _AuthEventManager = class _AuthEventManager {
  constructor(auth) {
    this.auth = auth;
...
__name(_AuthEventManager, "AuthEventManager");
var AuthEventManager = _AuthEventManager;
function eventUid(e) {
...
var _AuthPopup = class _AuthPopup {
  constructor(window2) {
    this.window = window2;
...
__name(_AuthPopup, "AuthPopup");
var AuthPopup = _AuthPopup;
...
var _BrowserPopupRedirectResolver = class _BrowserPopupRedirectResolver {
  constructor() {
    this.eventManagers = {};
    this.iframes = {};
...
__name(_BrowserPopupRedirectResolver, "BrowserPopupRedirectResolver");
var BrowserPopupRedirectResolver = _BrowserPopupRedirectResolver;
var browserPopupRedirectResolver = BrowserPopupRedirectResolver;
var _MultiFactorAssertionImpl = class _MultiFactorAssertionImpl {
...
__name(_MultiFactorAssertionImpl, "MultiFactorAssertionImpl");
var MultiFactorAssertionImpl = _MultiFactorAssertionImpl;
var _PhoneMultiFactorAssertionImpl = class _PhoneMultiFactorAssertionImpl extends MultiFactorAssertionImpl {
...
__name(_PhoneMultiFactorAssertionImpl, "PhoneMultiFactorAssertionImpl");
var PhoneMultiFactorAssertionImpl = _PhoneMultiFactorAssertionImpl;
var _PhoneMultiFactorGenerator = class _PhoneMultiFactorGenerator {
  constructor() {
  }
  /**
...
__name(_PhoneMultiFactorGenerator, "PhoneMultiFactorGenerator");
var PhoneMultiFactorGenerator = _PhoneMultiFactorGenerator;
PhoneMultiFactorGenerator.FACTOR_ID = "phone";
var _TotpMultiFactorGenerator = class _TotpMultiFactorGenerator {
  /**
...
__name(_TotpMultiFactorGenerator, "TotpMultiFactorGenerator");
var TotpMultiFactorGenerator = _TotpMultiFactorGenerator;
TotpMultiFactorGenerator.FACTOR_ID = "totp";
var _TotpMultiFactorAssertionImpl = class _TotpMultiFactorAssertionImpl extends MultiFactorAssertionImpl {
...
__name(_TotpMultiFactorAssertionImpl, "TotpMultiFactorAssertionImpl");
var TotpMultiFactorAssertionImpl = _TotpMultiFactorAssertionImpl;
var _TotpSecret = class _TotpSecret {
...
__name(_TotpSecret, "TotpSecret");
var TotpSecret = _TotpSecret;
...
var version = "1.10.8";
var _AuthInterop = class _AuthInterop {
  constructor(auth) {
    this.auth = auth;
...
__name(_AuthInterop, "AuthInterop");
var AuthInterop = _AuthInterop;
...
var mintCookieFactory = /* @__PURE__ */ __name((url) => (user) => __async(null, null, function* () {
...
@firebase/auth/dist/esm2017/index-35c79a8a.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-UZEY6DZM.js.map
