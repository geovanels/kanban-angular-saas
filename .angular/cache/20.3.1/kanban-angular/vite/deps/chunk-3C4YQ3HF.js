...
(function() {
  ...
  function ea(a, b) {
    ...
    var c = 0, d = false, e = { next: /* @__PURE__ */ __name(function() {
      if (!d && c < a.length) {
        var f = c++;
  ...
  __name(_Ca, "Ca");
  let Ca = _Ca;
  let x2, y = false, za = new Aa(), Ea = /* @__PURE__ */ __name(() => {
  ...
  __name(cb, "cb");
  const _eb = class _eb extends z2 {
    constructor(a, b) {
      super();
      this.m = a;
      this.l = b;
  ...
  __name(Lc, "Lc");
  Object.defineProperty(Kc.prototype, "withCredentials", { get: /* @__PURE__ */ __name(function() {
...
var ___PRIVATE_EmptyAppCheckTokenProvider = class ___PRIVATE_EmptyAppCheckTokenProvider {
  getToken() {
...
__name(___PRIVATE_EmptyAppCheckTokenProvider, "__PRIVATE_EmptyAppCheckTokenProvider");
var __PRIVATE_EmptyAppCheckTokenProvider = ___PRIVATE_EmptyAppCheckTokenProvider;
...
__name(__PRIVATE_getUtf8SafeSubstring, "__PRIVATE_getUtf8SafeSubstring");
...
__name(__PRIVATE_compareByteArrays$1, "__PRIVATE_compareByteArrays$1");
...
var _IndexSegment = class _IndexSegment {
  constructor(e, t) {
    this.fieldPath = e, this.kind = t;
  }
};
__name(_IndexSegment, "IndexSegment");
var IndexSegment = _IndexSegment;
...
var _IndexState = class _IndexState {
  constructor(e, t) {
...
__name(_IndexState, "IndexState");
var IndexState = _IndexState;
...
var U = "SimpleDb";
var ___PRIVATE_SimpleDbTransaction = class ___PRIVATE_SimpleDbTransaction {
  static open(e, t, n, r) {
    try {
...
__name(___PRIVATE_SimpleDbTransaction, "__PRIVATE_SimpleDbTransaction");
var __PRIVATE_SimpleDbTransaction = ___PRIVATE_SimpleDbTransaction;
var ___PRIVATE_SimpleDb = class ___PRIVATE_SimpleDb {
...
__name(___PRIVATE_SimpleDb, "__PRIVATE_SimpleDb");
var __PRIVATE_SimpleDb = ___PRIVATE_SimpleDb;
...
var ___PRIVATE_IterationController = class ___PRIVATE_IterationController {
  constructor(e) {
...
__name(___PRIVATE_IterationController, "__PRIVATE_IterationController");
var __PRIVATE_IterationController = ___PRIVATE_IterationController;
var ___PRIVATE_IndexedDbTransactionError = class ___PRIVATE_IndexedDbTransactionError extends FirestoreError {
  constructor(e, t) {
    super(N.UNAVAILABLE, `IndexedDB transaction '${e}' failed: ${t}`), this.name = "IndexedDbTransactionError";
  }
};
__name(___PRIVATE_IndexedDbTransactionError, "__PRIVATE_IndexedDbTransactionError");
var __PRIVATE_IndexedDbTransactionError = ___PRIVATE_IndexedDbTransactionError;
function __PRIVATE_isIndexedDbTransactionError(e) {
  return "IndexedDbTransactionError" === e.name;
}
__name(__PRIVATE_isIndexedDbTransactionError, "__PRIVATE_isIndexedDbTransactionError");
var ___PRIVATE_SimpleDbStore = class ___PRIVATE_SimpleDbStore {
  constructor(e) {
    this.store = e;
  }
  put(e, t) {
...
__name(___PRIVATE_SimpleDbStore, "__PRIVATE_SimpleDbStore");
var __PRIVATE_SimpleDbStore = ___PRIVATE_SimpleDbStore;
...
var ___PRIVATE_IndexBackfillerScheduler = class ___PRIVATE_IndexBackfillerScheduler {
  constructor(e, t) {
...
__name(___PRIVATE_IndexBackfillerScheduler, "__PRIVATE_IndexBackfillerScheduler");
var __PRIVATE_IndexBackfillerScheduler = ___PRIVATE_IndexBackfillerScheduler;
var ___PRIVATE_IndexBackfiller = class ___PRIVATE_IndexBackfiller {
  constructor(e, t) {
...
__name(___PRIVATE_IndexBackfiller, "__PRIVATE_IndexBackfiller");
var __PRIVATE_IndexBackfiller = ___PRIVATE_IndexBackfiller;
...
var nt = [...et, je];
var rt = nt;
var ___PRIVATE_IndexedDbTransaction = class ___PRIVATE_IndexedDbTransaction extends PersistenceTransaction {
  constructor(e, t) {
    super(), this.ce = e, this.currentSequenceNumber = t;
  }
};
__name(___PRIVATE_IndexedDbTransaction, "__PRIVATE_IndexedDbTransaction");
var __PRIVATE_IndexedDbTransaction = ___PRIVATE_IndexedDbTransaction;
...
function __PRIVATE_canonifyTarget(e) {
  ...
  if (null === t.Pe) {
    ...
    }, "__PRIVATE_canonifyOrderBy"))(e3))).join(","), __PRIVATE_isNullOrUndefined(t.limit) || (e2 += "|l:", e2 += t.limit), t.startAt && (e2 += "|lb:", e2 += t.startAt.inclusive ? "b:" : "a:", e2 += t.startAt.position.map(((e3) => canonicalId(e3))).join(",")), t.endAt && (e2 += "|ub:", e2 += t.endAt.inclusive ? "a:" : "b:", e2 += t.endAt.position.map(((e3) => canonicalId(e3))).join(",")), t.Pe = e2;
  }
  return t.Pe;
}
...
var ___PRIVATE_NumericIncrementTransformOperation = class ___PRIVATE_NumericIncrementTransformOperation extends TransformOperation {
  constructor(e, t) {
...
var ___PRIVATE_AggregateImpl = class ___PRIVATE_AggregateImpl {
  constructor(e, t, n) {
    this.alias = e, this.aggregateType = t, this.fieldPath = n;
  }
};
__name(___PRIVATE_AggregateImpl, "__PRIVATE_AggregateImpl");
var __PRIVATE_AggregateImpl = ___PRIVATE_AggregateImpl;
    ...
    if (r) {
      ...
      if (__PRIVATE_targetIsDocumentTarget(i)) if (0 === n) {
        ...
        if (r2 !== n) {
          ...
          null == pt || pt.ct((/* @__PURE__ */ __name(function __PRIVATE_createExistenceFilterMismatchInfoForTestingHooks(e2, t2, n3, r3, i3) {
            var s, o, _, a, u, c;
            const l = {
              localCacheCount: e2,
            ...
            h && (l.bloomFilter = {
              ...
              mightContain: /* @__PURE__ */ __name((e3) => {
                var t3;
                return null !== (t3 = null == r3 ? void 0 : r3.mightContain(e3)) && void 0 !== t3 && t3;
              }, "mightContain")
            });
            return l;
          }, "__PRIVATE_createExistenceFilterMismatchInfoForTestingHooks"))(r2, e.De, this.We.lt(), n2, i2));
        }
      }
    }
  }
...
function __PRIVATE_fromBatchGetDocumentsResponse(e, t) {
  return "found" in t ? (/* @__PURE__ */ __name(function __PRIVATE_fromFound(e2, t2) {
  ...
  }, "__PRIVATE_fromFound"))(e, t) : "missing" in t ? (/* @__PURE__ */ __name(function __PRIVATE_fromMissing(e2, t2) {
  ...
  }, "__PRIVATE_fromMissing"))(e, t) : fail(7234, {
    result: t
  });
}
...
function __PRIVATE_fromMutation(e, t) {
  const n = t.currentDocument ? (/* @__PURE__ */ __name(function __PRIVATE_fromPrecondition(e2) {
  ...
  }, "__PRIVATE_fromPrecondition"))(t.currentDocument) : Precondition.none(), r = t.updateTransforms ? t.updateTransforms.map(((t2) => (/* @__PURE__ */ __name(function __PRIVATE_fromFieldTransform(e2, t3) {
    let n2 = null;
  ...
  }, "__PRIVATE_fromFieldTransform"))(e, t2))) : [];
  if (t.update) {
    t.update.name;
    ...
    if (t.updateMask) {
      ...
      }, "__PRIVATE_fromDocumentMask"))(t.updateMask);
...
function __PRIVATE_fromDbRemoteDocument(e, t) {
  ...
  return t.readTime && n.setReadTime((/* @__PURE__ */ __name(function __PRIVATE_fromDbTimestampKey(e2) {
    const t2 = new Timestamp(e2[0], e2[1]);
    return SnapshotVersion.fromTimestamp(t2);
  }, "__PRIVATE_fromDbTimestampKey"))(t.readTime)), n;
}
...
function __PRIVATE_toDbRemoteDocument(e, t) {
  ...
  if (t.isFoundDocument()) r.document = (/* @__PURE__ */ __name(function __PRIVATE_toDocument(e2, t2) {
    return {
...
function __PRIVATE_fromDbTarget(e) {
  ...
  */
  ...
  }, "__PRIVATE_fromQueryTarget"))(e.query), new TargetData(r, e.targetId, "TargetPurposeListen", e.lastListenSequenceNumber, t, n, ByteString.fromBase64String(e.resumeToken));
}
...
var ___PRIVATE_IndexedDbBundleCache = class ___PRIVATE_IndexedDbBundleCache {
  getBundleMetadata(e, t) {
    return __PRIVATE_bundlesStore(e).get(t).next(((e2) => {
      if (e2) return (/* @__PURE__ */ __name(function __PRIVATE_fromDbBundle(e3) {
        return {
          id: e3.bundleId,
  ...
  saveBundleMetadata(e, t) {
    ...
    }, "__PRIVATE_toDbBundle"))(t));
  }
  getNamedQuery(e, t) {
    return __PRIVATE_namedQueriesStore(e).get(t).next(((e2) => {
      if (e2) return (/* @__PURE__ */ __name(function __PRIVATE_fromDbNamedQuery(e3) {
        return {
          name: e3.name,
  ...
  saveNamedQuery(e, t) {
    ...
    }, "__PRIVATE_toDbNamedQuery"))(t));
  }
};
__name(___PRIVATE_IndexedDbBundleCache, "__PRIVATE_IndexedDbBundleCache");
var __PRIVATE_IndexedDbBundleCache = ___PRIVATE_IndexedDbBundleCache;
...
var ___PRIVATE_IndexedDbDocumentOverlayCache = class ___PRIVATE_IndexedDbDocumentOverlayCache {
  /**
  ...
  wt(e, t) {
    return __PRIVATE_documentOverlayStore(e).put((/* @__PURE__ */ __name(function __PRIVATE_toDbDocumentOverlay(e2, t2, n) {
    ...
    }, "__PRIVATE_toDbDocumentOverlay"))(this.serializer, this.userId, t));
  }
};
__name(___PRIVATE_IndexedDbDocumentOverlayCache, "__PRIVATE_IndexedDbDocumentOverlayCache");
var __PRIVATE_IndexedDbDocumentOverlayCache = ___PRIVATE_IndexedDbDocumentOverlayCache;
...
var ___PRIVATE_IndexedDbGlobalsCache = class ___PRIVATE_IndexedDbGlobalsCache {
  St(e) {
...
__name(___PRIVATE_IndexedDbGlobalsCache, "__PRIVATE_IndexedDbGlobalsCache");
var __PRIVATE_IndexedDbGlobalsCache = ___PRIVATE_IndexedDbGlobalsCache;
...
function __PRIVATE_unsignedNumLength(e) {
  const t = 64 - (/* @__PURE__ */ __name(function __PRIVATE_numberOfLeadingZeros(e2) {
    let t2 = 0;
    for (let n = 0; n < 8; ++n) {
...
var ___PRIVATE_OrderedCodeWriter = class ___PRIVATE_OrderedCodeWriter {
  constructor() {
...
__name(___PRIVATE_OrderedCodeWriter, "__PRIVATE_OrderedCodeWriter");
var __PRIVATE_OrderedCodeWriter = ___PRIVATE_OrderedCodeWriter;
var ___PRIVATE_AscendingIndexByteEncoder = class ___PRIVATE_AscendingIndexByteEncoder {
  constructor(e) {
    this.un = e;
  }
  Nt(e) {
...
__name(___PRIVATE_AscendingIndexByteEncoder, "__PRIVATE_AscendingIndexByteEncoder");
var __PRIVATE_AscendingIndexByteEncoder = ___PRIVATE_AscendingIndexByteEncoder;
var ___PRIVATE_DescendingIndexByteEncoder = class ___PRIVATE_DescendingIndexByteEncoder {
  constructor(e) {
    this.un = e;
  }
  Nt(e) {
...
__name(___PRIVATE_DescendingIndexByteEncoder, "__PRIVATE_DescendingIndexByteEncoder");
var __PRIVATE_DescendingIndexByteEncoder = ___PRIVATE_DescendingIndexByteEncoder;
var ___PRIVATE_IndexByteEncoder = class ___PRIVATE_IndexByteEncoder {
  constructor() {
...
__name(___PRIVATE_IndexByteEncoder, "__PRIVATE_IndexByteEncoder");
var __PRIVATE_IndexByteEncoder = ___PRIVATE_IndexByteEncoder;
var ___PRIVATE_IndexEntry = class ___PRIVATE_IndexEntry {
  constructor(e, t, n, r) {
...
__name(___PRIVATE_IndexEntry, "__PRIVATE_IndexEntry");
var __PRIVATE_IndexEntry = ___PRIVATE_IndexEntry;
...
function __PRIVATE_encodeKeySafeBytes(e) {
  return isSafariOrWebkit() ? (
    ...
    */
    (/* @__PURE__ */ __name(function __PRIVATE_encodeUint8ArrayToSortableString(e2) {
      let t = "";
      for (let n = 0; n < e2.length; n++) t += String.fromCharCode(e2[n]);
      return t;
    }, "__PRIVATE_encodeUint8ArrayToSortableString"))(e)
  ) : e;
}
__name(__PRIVATE_encodeKeySafeBytes, "__PRIVATE_encodeKeySafeBytes");
function __PRIVATE_decodeKeySafeBytes(e) {
  return "string" != typeof e ? e : (/* @__PURE__ */ __name(function __PRIVATE_decodeSortableStringToUint8Array(e2) {
    const t = new Uint8Array(e2.length);
    for (let n = 0; n < e2.length; n++) t[n] = e2.charCodeAt(n);
    return t;
  }, "__PRIVATE_decodeSortableStringToUint8Array"))(e);
}
__name(__PRIVATE_decodeKeySafeBytes, "__PRIVATE_decodeKeySafeBytes");
var ___PRIVATE_TargetIndexMatcher = class ___PRIVATE_TargetIndexMatcher {
  constructor(e) {
...
__name(___PRIVATE_TargetIndexMatcher, "__PRIVATE_TargetIndexMatcher");
var __PRIVATE_TargetIndexMatcher = ___PRIVATE_TargetIndexMatcher;
...
function __PRIVATE_applyDistribution(e, t) {
  ...
  n = e instanceof FieldFilter ? t instanceof FieldFilter ? (/* @__PURE__ */ __name(function __PRIVATE_applyDistributionFieldFilters(e2, t2) {
    return CompositeFilter.create(
      [e2, t2],
      "and"
      /* CompositeOperator.AND */
    );
  }, "__PRIVATE_applyDistributionFieldFilters"))(e, t) : __PRIVATE_applyDistributionFieldAndCompositeFilters(e, t) : t instanceof FieldFilter ? __PRIVATE_applyDistributionFieldAndCompositeFilters(t, e) : (/* @__PURE__ */ __name(function __PRIVATE_applyDistributionCompositeFilters(e2, t2) {
  ...
  }, "__PRIVATE_applyDistributionCompositeFilters"))(e, t), __PRIVATE_applyAssociation(n);
}
...
var ___PRIVATE_IndexedDbIndexManager = class ___PRIVATE_IndexedDbIndexManager {
  constructor(e, t) {
    this.databaseId = t, /**
  ...
  addFieldIndex(e, t) {
    const n = __PRIVATE_indexConfigurationStore(e), r = (/* @__PURE__ */ __name(function __PRIVATE_toDbIndexConfiguration(e2) {
      return {
        indexId: e2.indexId,
        collectionGroup: e2.collectionGroup,
        fields: e2.fields.map(((e3) => [e3.fieldPath.canonicalString(), e3.kind]))
      };
    }, "__PRIVATE_toDbIndexConfiguration"))(t);
    delete r.indexId;
    const i = n.add(r);
    if (t.indexState) {
    ...
    return PersistencePromise.forEach(this.Fn(t), ((t2) => this.Mn(e, t2).next(((e2) => {
      ...
      if (r) {
        ...
        return PersistencePromise.forEach(i, ((i2, s) => {
          __PRIVATE_logDebug(vt, `Using index ${(/* @__PURE__ */ __name(function __PRIVATE_fieldIndexToString(e3) {
            return `id=${e3.indexId}|cg=${e3.collectionGroup}|f=${e3.fields.map(((e4) => `${e4.fieldPath}:${e4.kind}`)).join(",")}`;
          }, "__PRIVATE_fieldIndexToString"))(i2)} to execute ${__PRIVATE_canonifyTarget(t)}`);
          const o = (/* @__PURE__ */ __name(function __PRIVATE_targetGetArrayValues(e3, t2) {
            ...
            return null;
          }, "__PRIVATE_targetGetArrayValues"))(s, i2), _ = (/* @__PURE__ */ __name(function __PRIVATE_targetGetNotInValues(e3, t2) {
            ...
            return null;
          }, "__PRIVATE_targetGetNotInValues"))(s, i2), a = (/* @__PURE__ */ __name(function __PRIVATE_targetGetLowerBound(e3, t2) {
            const n2 = [];
            let r3 = true;
          ...
          }, "__PRIVATE_targetGetLowerBound"))(s, i2), u = (/* @__PURE__ */ __name(function __PRIVATE_targetGetUpperBound(e3, t2) {
            const n2 = [];
            let r3 = true;
            for (const i3 of __PRIVATE_fieldIndexGetDirectionalSegments(t2)) {
            ...
            return new Bound(n2, r3);
          }, "__PRIVATE_targetGetUpperBound"))(s, i2), c = this.xn(i2, s, a), l = this.xn(i2, s, u), h = this.On(i2, s, _), P = this.Nn(i2.indexId, o, c, a.inclusive, l, u.inclusive, h);
  ...
  getIndexType(e, t) {
    ...
    return PersistencePromise.forEach(r, ((t2) => this.Mn(e, t2).next(((e2) => {
      e2 ? 0 !== n && e2.fields.length < (/* @__PURE__ */ __name(function __PRIVATE_targetGetSegmentCount(e3) {
      ...
      }, "__PRIVATE_targetGetSegmentCount"))(t2) && (n = 1) : n = 0;
    })))).next((() => (
      ...
      }, "__PRIVATE_targetHasLimit"))(t) && r.length > 1 && 2 === n ? 1 : n
    )));
  }
  /**
  ...
  Qn(e, t) {
    const n = new __PRIVATE_IndexByteEncoder();
    return __PRIVATE_FirestoreIndexValueWriter.Ut.bt(__PRIVATE_refValue(this.databaseId, t), n.hn((/* @__PURE__ */ __name(function __PRIVATE_fieldIndexGetKeyOrder(e2) {
      const t2 = __PRIVATE_fieldIndexGetDirectionalSegments(e2);
      return 0 === t2.length ? 0 : t2[t2.length - 1].kind;
    }, "__PRIVATE_fieldIndexGetKeyOrder"))(e))), n.an();
  }
  /**
  ...
  getFieldIndexes(e, t) {
    ...
    return (t ? n.j(Fe, IDBKeyRange.bound(t, t)) : n.j()).next(((e2) => {
      ...
      return PersistencePromise.forEach(e2, ((e3) => r.get([e3.indexId, this.uid]).next(((n2) => {
        t2.push((/* @__PURE__ */ __name(function __PRIVATE_fromDbIndexConfiguration(e4, t3) {
        ...
        }, "__PRIVATE_fromDbIndexConfiguration"))(e3, n2));
      })))).next((() => t2));
    }));
  }
  getNextCollectionGroupToUpdate(e) {
  ...
  jn(e, t, n, r, i) {
    ...
    const s = [];
    return (/* @__PURE__ */ __name(function __PRIVATE_diffSortedSets(e2, t2, n2, r2, i2) {
...
__name(___PRIVATE_IndexedDbIndexManager, "__PRIVATE_IndexedDbIndexManager");
var __PRIVATE_IndexedDbIndexManager = ___PRIVATE_IndexedDbIndexManager;
...
var ___PRIVATE_IndexedDbMutationQueue = class ___PRIVATE_IndexedDbMutationQueue {
  constructor(e, t, n, r) {
  ...
  addMutationBatch(e, t, n, r) {
    ...
    return s.add({}).next(((o) => {
      ...
      const _ = new MutationBatch(o, t, n, r), a = (/* @__PURE__ */ __name(function __PRIVATE_toDbMutationBatch(e2, t2, n2) {
      ...
      }, "__PRIVATE_toDbMutationBatch"))(this.serializer, this.userId, _), u = [];
...
__name(___PRIVATE_IndexedDbMutationQueue, "__PRIVATE_IndexedDbMutationQueue");
var __PRIVATE_IndexedDbMutationQueue = ___PRIVATE_IndexedDbMutationQueue;
...
var ___PRIVATE_IndexedDbTargetCache = class ___PRIVATE_IndexedDbTargetCache {
  constructor(e, t) {
...
__name(___PRIVATE_IndexedDbTargetCache, "__PRIVATE_IndexedDbTargetCache");
var __PRIVATE_IndexedDbTargetCache = ___PRIVATE_IndexedDbTargetCache;
...
var ___PRIVATE_IndexedDbLruDelegateImpl = class ___PRIVATE_IndexedDbLruDelegateImpl {
  constructor(e, t) {
   ...
   */
  Sr(e, t) {
    return (/* @__PURE__ */ __name(function __PRIVATE_mutationQueuesContainKey(e2, t2) {
      let n = false;
    ...
    }, "__PRIVATE_mutationQueuesContainKey"))(e, t);
  }
  removeOrphanedDocuments(e, t) {
    ...
    return this.wr(e, ((s, o) => {
      if (o <= t) {
        const t2 = this.Sr(e, s).next(((t3) => {
          if (!t3)
            return i++, n.getEntry(e, s).next((() => (n.removeEntry(s, SnapshotVersion.min()), __PRIVATE_documentTargetStore(e).delete((/* @__PURE__ */ __name(function __PRIVATE_sentinelKey$1(e2) {
              return [0, __PRIVATE_encodeResourcePath(e2.path)];
            }, "__PRIVATE_sentinelKey$1"))(s)))));
        }));
        r.push(t2);
      }
...
__name(___PRIVATE_IndexedDbLruDelegateImpl, "__PRIVATE_IndexedDbLruDelegateImpl");
var __PRIVATE_IndexedDbLruDelegateImpl = ___PRIVATE_IndexedDbLruDelegateImpl;
function __PRIVATE_writeSentinelKey(e, t) {
  return __PRIVATE_documentTargetStore(e).put((/* @__PURE__ */ __name(function __PRIVATE_sentinelRow(e2, t2) {
    return {
      targetId: 0,
      path: __PRIVATE_encodeResourcePath(e2.path),
      sequenceNumber: t2
    };
  }, "__PRIVATE_sentinelRow"))(t, e.currentSequenceNumber));
}
...
var ___PRIVATE_IndexedDbRemoteDocumentCacheImpl = class ___PRIVATE_IndexedDbRemoteDocumentCacheImpl {
  constructor(e) {
    this.serializer = e;
  }
  setIndexManager(e) {
  ...
  removeEntry(e, t, n) {
    return __PRIVATE_remoteDocumentsStore(e).delete(
      ...
      */
      (/* @__PURE__ */ __name(function __PRIVATE_dbReadTimeKey(e2, t2) {
...
__name(___PRIVATE_IndexedDbRemoteDocumentCacheImpl, "__PRIVATE_IndexedDbRemoteDocumentCacheImpl");
var __PRIVATE_IndexedDbRemoteDocumentCacheImpl = ___PRIVATE_IndexedDbRemoteDocumentCacheImpl;
...
var ___PRIVATE_IndexedDbRemoteDocumentChangeBuffer = class ___PRIVATE_IndexedDbRemoteDocumentChangeBuffer extends RemoteDocumentChangeBuffer {
  /**
...
__name(___PRIVATE_IndexedDbRemoteDocumentChangeBuffer, "__PRIVATE_IndexedDbRemoteDocumentChangeBuffer");
var __PRIVATE_IndexedDbRemoteDocumentChangeBuffer = ___PRIVATE_IndexedDbRemoteDocumentChangeBuffer;
...
var _LocalDocumentsView = class _LocalDocumentsView {
  ...
  getDocumentsMatchingQuery(e, t, n, r) {
    ...
    }, "__PRIVATE_isDocumentQuery$1"))(t) ? this.getDocumentsMatchingDocumentQuery(e, t.path) : __PRIVATE_isCollectionGroupQuery(t) ? this.getDocumentsMatchingCollectionGroupQuery(e, t, n, r) : this.getDocumentsMatchingCollectionQuery(e, t, n, r);
  }
  /**
...
var ___PRIVATE_MemoryBundleCache = class ___PRIVATE_MemoryBundleCache {
  ...
  saveNamedQuery(e, t) {
    return this.Lr.set(t.name, (/* @__PURE__ */ __name(function __PRIVATE_fromProtoNamedQuery(e2) {
      return {
        name: e2.name,
...
var ___PRIVATE_MemoryPersistence = class ___PRIVATE_MemoryPersistence {
  ...
  constructor(e, t) {
    ...
    }, "__PRIVATE_newMemoryRemoteDocumentCache"))(((e2) => this.referenceDelegate.Pi(e2))), this.serializer = new __PRIVATE_LocalSerializer(t), this.Ti = new __PRIVATE_MemoryBundleCache(this.serializer);
  }
  start() {
...
var ___PRIVATE_SchemaConverter = class ___PRIVATE_SchemaConverter {
  constructor(e) {
    this.serializer = e;
  }
  /**
  ...
  q(e, t, n, r) {
    ...
    n < 1 && r >= 1 && (!(/* @__PURE__ */ __name(function __PRIVATE_createPrimaryClientStore(e2) {
    ...
    (0 !== n && (!(/* @__PURE__ */ __name(function __PRIVATE_dropQueryCache(e2) {
      e2.deleteObjectStore(de), e2.deleteObjectStore(Pe), e2.deleteObjectStore(me);
    }, "__PRIVATE_dropQueryCache"))(e), __PRIVATE_createQueryCache(e)), s = s.next((() => (
      /**
    ...
    // be auto-generated.
    (s = s.next((() => (/* @__PURE__ */ __name(function __PRIVATE_upgradeMutationBatchSchemaAndMigrateData(e2, t2) {
      const n2 = t2.store(X);
      return n2.j().next(((n3) => {
    ...
    }, "__PRIVATE_upgradeMutationBatchSchemaAndMigrateData"))(e, i)))), s = s.next((() => {
    ...
    }))), n < 5 && r >= 5 && (s = s.next((() => this.pi(i)))), n < 6 && r >= 6 && (s = s.next((() => ((/* @__PURE__ */ __name(function __PRIVATE_createDocumentGlobalStore(e2) {
      e2.createObjectStore(le);
    }, "__PRIVATE_createDocumentGlobalStore"))(e), this.yi(i))))), n < 7 && r >= 7 && (s = s.next((() => this.wi(i)))), n < 8 && r >= 8 && (s = s.next((() => this.Si(e, i)))), n < 9 && r >= 9 && (s = s.next((() => {
    ...
    }))), n < 13 && r >= 13 && (s = s.next((() => (/* @__PURE__ */ __name(function __PRIVATE_createRemoteDocumentCache(e2) {
      const t2 = e2.createObjectStore(se, {
        keyPath: oe
      });
      t2.createIndex(_e, ae), t2.createIndex(ue, ce);
    }, "__PRIVATE_createRemoteDocumentCache"))(e))).next((() => this.Di(e, i))).next((() => e.deleteObjectStore(j)))), n < 14 && r >= 14 && (s = s.next((() => this.Ci(e, i)))), n < 15 && r >= 15 && (s = s.next((() => (/* @__PURE__ */ __name(function __PRIVATE_createFieldIndex(e2) {
    ...
    }, "__PRIVATE_createFieldIndex"))(e)))), n < 16 && r >= 16 && // Clear the object stores to remove possibly corrupted index entries
    (s = s.next((() => {
  ...
  wi(e) {
    ...
    return e.store(me).get(Ve).next(((e2) => {
      const r = [];
      return n.X(((n2, i) => {
        const s = new ResourcePath(n2), o = (/* @__PURE__ */ __name(function __PRIVATE_sentinelKey(e3) {
          return [0, __PRIVATE_encodeResourcePath(e3)];
        }, "__PRIVATE_sentinelKey"))(s);
  ...
  Si(e, t) {
    ...
    const n = t.store(fe), r = new __PRIVATE_MemoryCollectionParentIndex(), addEntry = /* @__PURE__ */ __name((e2) => {
      if (r.add(e2)) {
  ...
  Di(e, t) {
    const n = t.store(j), r = [];
    return n.X(((e2, n2) => {
      const i = t.store(se), s = (/* @__PURE__ */ __name(function __PRIVATE_extractKey(e3) {
      ...
      }, "__PRIVATE_extractKey"))(n2).path.toArray(), o = {
...
__name(___PRIVATE_SchemaConverter, "__PRIVATE_SchemaConverter");
var __PRIVATE_SchemaConverter = ___PRIVATE_SchemaConverter;
...
var qt = "main";
var ___PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  ...
  runTransaction(e, t, n) {
    ...
    const r = "readonly" === t ? "readonly" : "readwrite", i = (
      ...
      }, "__PRIVATE_getObjectStores"))(this.Oi)
    );
    let s;
...
__name(___PRIVATE_IndexedDbPersistence, "__PRIVATE_IndexedDbPersistence");
var __PRIVATE_IndexedDbPersistence = ___PRIVATE_IndexedDbPersistence;
    ...
    t.targetChanges.forEach(((s2, _2) => {
      ...
      */
      (/* @__PURE__ */ __name(function __PRIVATE_shouldPersistTargetData(e3, t2, n2) {
        ...
        return i2 > 0;
      }, "__PRIVATE_shouldPersistTargetData"))(a2, u, s2) && o.push(n.hi.updateTargetData(e2, u));
    }));
...
function __PRIVATE_localStoreApplyBundledDocuments(e, t, n, r) {
  return __async(this, null, function* () {
    ...
    const _ = i.Os.newChangeBuffer({
      trackRemovals: true
    }), a = yield __PRIVATE_localStoreAllocateTarget(i, (/* @__PURE__ */ __name(function __PRIVATE_umbrellaTarget(e2) {
      return __PRIVATE_queryToTarget(__PRIVATE_newQueryForPath(ResourcePath.fromString(`__bundle__/docs/${e2}`)));
    }, "__PRIVATE_umbrellaTarget"))(r));
...
var ___PRIVATE_MutationMetadata = class ___PRIVATE_MutationMetadata {
  constructor(e, t, n, r) {
...
__name(___PRIVATE_MutationMetadata, "__PRIVATE_MutationMetadata");
var __PRIVATE_MutationMetadata = ___PRIVATE_MutationMetadata;
var ___PRIVATE_QueryTargetMetadata = class ___PRIVATE_QueryTargetMetadata {
  constructor(e, t, n) {
...
__name(___PRIVATE_QueryTargetMetadata, "__PRIVATE_QueryTargetMetadata");
var __PRIVATE_QueryTargetMetadata = ___PRIVATE_QueryTargetMetadata;
var ___PRIVATE_RemoteClientState = class ___PRIVATE_RemoteClientState {
  constructor(e, t) {
...
__name(___PRIVATE_RemoteClientState, "__PRIVATE_RemoteClientState");
var __PRIVATE_RemoteClientState = ___PRIVATE_RemoteClientState;
var ___PRIVATE_SharedOnlineState = class ___PRIVATE_SharedOnlineState {
  constructor(e, t) {
...
__name(___PRIVATE_SharedOnlineState, "__PRIVATE_SharedOnlineState");
var __PRIVATE_SharedOnlineState = ___PRIVATE_SharedOnlineState;
...
var ___PRIVATE_WebStorageSharedClientState = class ___PRIVATE_WebStorageSharedClientState {
  constructor(e, t, n, r, i) {
    ...
    }, "createWebStorageSequenceNumberKey"))(this.persistenceKey), this.Ys = this.Ys.insert(this.js, new __PRIVATE_LocalClientState()), this.no = new RegExp(`^${Ut}_${s}_([^_]*)$`), this.ro = new RegExp(`^${Kt}_${s}_(\\d+)(?:_(.*))?$`), this.io = new RegExp(`^${Wt}_${s}_(\\d+)$`), this.so = /** Assembles the key for the online state of the primary tab. */
    (/* @__PURE__ */ __name(function createWebStorageOnlineStateKey(e2) {
      return `firestore_online_state_${e2}`;
    }, "createWebStorageOnlineStateKey"))(this.persistenceKey), this.oo = (/* @__PURE__ */ __name(function createBundleLoadedKey(e2) {
          ...
          if (null !== t.key) {
            if (this.no.test(t.key)) {
              ...
              const e2 = (/* @__PURE__ */ __name(function __PRIVATE_fromWebStorageSequenceNumber(e3) {
                ...
                return t2;
              }, "__PRIVATE_fromWebStorageSequenceNumber"))(t.newValue);
...
__name(___PRIVATE_WebStorageSharedClientState, "__PRIVATE_WebStorageSharedClientState");
var __PRIVATE_WebStorageSharedClientState = ___PRIVATE_WebStorageSharedClientState;
...
function __PRIVATE_generateUniqueDebugId() {
  return null === jt ? jt = (/* @__PURE__ */ __name(function __PRIVATE_generateInitialUniqueDebugId() {
    return 268435456 + Math.round(2147483648 * Math.random());
  }, "__PRIVATE_generateInitialUniqueDebugId"))() : jt++, "0x" + jt.toString(16);
}
...
var ___PRIVATE_WebChannelConnection = class ___PRIVATE_WebChannelConnection extends __PRIVATE_RestConnection {
  ...
  P_(e, t, n) {
    ...
    const P = new __PRIVATE_StreamBridge({
      ...
      Yo: /* @__PURE__ */ __name(() => c.close(), "Yo")
    }), __PRIVATE_unguardedEventListen = /* @__PURE__ */ __name((e2, t2, n2) => {
      e2.listen(t2, ((e3) => {
        try {
          n2(e3);
        } catch (e4) {
  ...
  constructor(e, t, n, r, i) {
    ...
    this.da = [], this.Ea = i, this.Ea.xo(((e2) => {
      n.enqueueAndForget((() => __async(this, null, function* () {
        __PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug(Xt, "Restarting streams for network reachability change."), yield (/* @__PURE__ */ __name(function __PRIVATE_restartNetwork(e3) {
          return __async(this, null, function* () {
...
function __PRIVATE_startWatchStream(e) {
  e.Ra = new __PRIVATE_WatchChangeAggregator({
    ...
    Et: /* @__PURE__ */ __name((t) => e.Ta.get(t) || null, "Et"),
...
function __PRIVATE_onWatchStreamChange(e, t, n) {
  return __async(this, null, function* () {
    if (
      ...
      try {
        yield (/* @__PURE__ */ __name(function __PRIVATE_handleTargetError(e2, t2) {
          return __async(this, null, function* () {
            const n2 = t2.cause;
      ...
      * SyncEngine.
      */
      (yield (/* @__PURE__ */ __name(function __PRIVATE_raiseWatchSnapshot(e2, t3) {
...
function __PRIVATE_onWriteStreamClose(e, t) {
  return __async(this, null, function* () {
    ...
    (yield (/* @__PURE__ */ __name(function __PRIVATE_handleWriteError(e2, t2) {
      return __async(this, null, function* () {
...
function __PRIVATE_ensureWatchStream(e) {
  ...
  (e.Va = (/* @__PURE__ */ __name(function __PRIVATE_newPersistentWatchStream(e2, t, n) {
...
function __PRIVATE_ensureWriteStream(e) {
  ...
  (e.ma = (/* @__PURE__ */ __name(function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    const r = __PRIVATE_debugCast(e2);
...
var ___PRIVATE_EventManagerImpl = class ___PRIVATE_EventManagerImpl {
  ...
  terminate() {
    ...
    }, "__PRIVATE_errorAllTargets"))(this, new FirestoreError(N.ABORTED, "Firestore shutting down"));
  }
};
...
var ___PRIVATE_SizedBundleElement = class ___PRIVATE_SizedBundleElement {
  constructor(e, t) {
...
__name(___PRIVATE_SizedBundleElement, "__PRIVATE_SizedBundleElement");
var __PRIVATE_SizedBundleElement = ___PRIVATE_SizedBundleElement;
var ___PRIVATE_BundleConverterImpl = class ___PRIVATE_BundleConverterImpl {
  constructor(e) {
    this.serializer = e;
  }
  Qs(e) {
...
__name(___PRIVATE_BundleConverterImpl, "__PRIVATE_BundleConverterImpl");
var __PRIVATE_BundleConverterImpl = ___PRIVATE_BundleConverterImpl;
var ___PRIVATE_BundleLoader = class ___PRIVATE_BundleLoader {
  constructor(e, t) {
...
__name(___PRIVATE_BundleLoader, "__PRIVATE_BundleLoader");
var __PRIVATE_BundleLoader = ___PRIVATE_BundleLoader;
...
var ___PRIVATE_View = class ___PRIVATE_View {
  ...
  applyChanges(e, t, n, r) {
    ...
    }, "__PRIVATE_compareChangeType"))(e2.type, t2.type) || this.Xa(e2.doc, t2.doc))), this.su(n), r = null != r && r;
...
function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
  return __async(this, null, function* () {
    e.gu = (t2, n2, r2) => (/* @__PURE__ */ __name(function __PRIVATE_applyDocChanges(e2, t3, n3, r3) {
      return __async(this, null, function* () {
...
function __PRIVATE_syncEngineWrite(e, t, n) {
  return __async(this, null, function* () {
    ...
    try {
      const e2 = yield (/* @__PURE__ */ __name(function __PRIVATE_localStoreWriteLocally(e3, t2) {
      ...
      }, "__PRIVATE_addMutationCallback"))(r, e2.batchId, n), yield __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(r, e2.changes), yield __PRIVATE_fillWritePipeline(r.remoteStore);
    } catch (e2) {
...
function __PRIVATE_syncEngineApplyOnlineStateChange(e, t, n) {
  ...
  if (r.isPrimaryClient && 0 === n || !r.isPrimaryClient && 1 === n) {
    ...
    }, "__PRIVATE_eventManagerOnOnlineStateChange"))(r.eventManager, t), e2.length && r.hu.J_(e2), r.onlineState = t, r.isPrimaryClient && r.sharedClientState.setOnlineState(t);
  }
}
...
function __PRIVATE_syncEngineRejectFailedWrite(e, t, n) {
  return __async(this, null, function* () {
    const r = __PRIVATE_debugCast(e);
    try {
      const e2 = yield (/* @__PURE__ */ __name(function __PRIVATE_localStoreRejectBatch(e3, t2) {
        const n2 = __PRIVATE_debugCast(e3);
...
function __PRIVATE_syncEngineRegisterPendingWritesCallback(e, t) {
  return __async(this, null, function* () {
    ...
    try {
      const e2 = yield (/* @__PURE__ */ __name(function __PRIVATE_localStoreGetHighestUnacknowledgedBatchId(e3) {
        const t2 = __PRIVATE_debugCast(e3);
      ...
      }, "__PRIVATE_localStoreGetHighestUnacknowledgedBatchId"))(n.localStore);
      if (e2 === G)
...
function __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, t, n) {
  return __async(this, null, function* () {
    ...
    })), yield Promise.all(o), r.hu.J_(i), yield (/* @__PURE__ */ __name(function __PRIVATE_localStoreNotifyLocalViewChanges(e2, t2) {
      return __async(this, null, function* () {
...
function __PRIVATE_syncEngineApplyBatchState(e, t, n, r) {
  return __async(this, null, function* () {
    const i = __PRIVATE_debugCast(e), s = yield (/* @__PURE__ */ __name(function __PRIVATE_localStoreLookupMutationDocuments(e2, t2) {
    ...
    }, "__PRIVATE_localStoreLookupMutationDocuments"))(i.localStore, t);
    null !== s ? ("pending" === n ? (
      ...
      // other clients.
      (__PRIVATE_processUserCallback(i, t, r || null), __PRIVATE_triggerPendingWritesCallbacks(i, t), (/* @__PURE__ */ __name(function __PRIVATE_localStoreRemoveCachedMutationBatchMetadata(e2, t2) {
        __PRIVATE_debugCast(__PRIVATE_debugCast(e2).mutationQueue).rr(t2);
      }, "__PRIVATE_localStoreRemoveCachedMutationBatchMetadata"))(i.localStore, t))
...
function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
  return __async(this, null, function* () {
    ...
    if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), true === t && true !== n.fu) {
      ...
      }, "__PRIVATE_resetLimboDocuments"))(n), n.fu = false, yield __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, false);
    }
  });
}
...
function __PRIVATE_syncEngineLoadBundle(e, t, n) {
  ...
  (/* @__PURE__ */ __name((function __PRIVATE_loadBundleImpl(e2, t2, n2) {
    return __async(this, null, function* () {
      try {
        const r2 = yield t2.getMetadata();
        if (yield (/* @__PURE__ */ __name(function __PRIVATE_localStoreHasNewerBundle(e3, t3) {
        ...
        }, "__PRIVATE_localStoreHasNewerBundle"))(e2.localStore, r2)) return yield t2.close(), n2._completeWith((/* @__PURE__ */ __name(function __PRIVATE_bundleSuccessProgress(e3) {
          return {
            taskState: "Success",
        ...
        }, "__PRIVATE_bundleSuccessProgress"))(r2)), Promise.resolve(/* @__PURE__ */ new Set());
        ...
        yield (/* @__PURE__ */ __name(function __PRIVATE_localStoreSaveBundle(e3, t3) {
        ...
        }, "__PRIVATE_localStoreSaveBundle"))(e2.localStore, r2), n2._completeWith(o.progress), Promise.resolve(o.ja);
      } catch (e3) {
        return __PRIVATE_logWarn(nn, `Loading bundle failed with ${e3}`), n2._failWith(e3), Promise.resolve(/* @__PURE__ */ new Set());
      }
    });
  }), "__PRIVATE_loadBundleImpl"))(r, t, n).then(((e2) => {
...
var ___PRIVATE_IndexedDbOfflineComponentProvider = class ___PRIVATE_IndexedDbOfflineComponentProvider extends __PRIVATE_MemoryOfflineComponentProvider {
  constructor(e, t, n) {
...
__name(___PRIVATE_IndexedDbOfflineComponentProvider, "__PRIVATE_IndexedDbOfflineComponentProvider");
var __PRIVATE_IndexedDbOfflineComponentProvider = ___PRIVATE_IndexedDbOfflineComponentProvider;
var ___PRIVATE_MultiTabOfflineComponentProvider = class ___PRIVATE_MultiTabOfflineComponentProvider extends __PRIVATE_IndexedDbOfflineComponentProvider {
  constructor(e, t) {
    super(
      e,
      t,
...
__name(___PRIVATE_MultiTabOfflineComponentProvider, "__PRIVATE_MultiTabOfflineComponentProvider");
var __PRIVATE_MultiTabOfflineComponentProvider = ___PRIVATE_MultiTabOfflineComponentProvider;
var _OnlineComponentProvider = class _OnlineComponentProvider {
  ...
  createDatastore(e) {
    const t = __PRIVATE_newSerializer(e.databaseInfo.databaseId), n = (/* @__PURE__ */ __name(function __PRIVATE_newConnection(e2) {
      return new __PRIVATE_WebChannelConnection(e2);
    }, "__PRIVATE_newConnection"))(e.databaseInfo);
    return (/* @__PURE__ */ __name(function __PRIVATE_newDatastore(e2, t2, n2, r) {
      return new __PRIVATE_DatastoreImpl(e2, t2, n2, r);
    }, "__PRIVATE_newDatastore"))(e.authCredentials, e.appCheckCredentials, n, t);
  }
  createRemoteStore(e) {
  ...
  terminate() {
    return __async(this, null, function* () {
      var e, t;
      yield (/* @__PURE__ */ __name(function __PRIVATE_remoteStoreShutdown(e2) {
        return __async(this, null, function* () {
      ...
      }, "__PRIVATE_remoteStoreShutdown"))(this.remoteStore), null === (e = this.datastore) || void 0 === e || e.terminate(), null === (t = this.eventManager) || void 0 === t || t.terminate();
    });
  }
};
...
var ___PRIVATE_BundleReaderImpl = class ___PRIVATE_BundleReaderImpl {
  constructor(e, t) {
     ...
     * content.
     */
    this.buffer = new Uint8Array(), this.Bu = (/* @__PURE__ */ __name(function __PRIVATE_newTextDecoder() {
...
__name(___PRIVATE_BundleReaderImpl, "__PRIVATE_BundleReaderImpl");
var __PRIVATE_BundleReaderImpl = ___PRIVATE_BundleReaderImpl;
var ___PRIVATE_BundleReaderSyncImpl = class ___PRIVATE_BundleReaderSyncImpl {
  constructor(e, t) {
...
__name(___PRIVATE_BundleReaderSyncImpl, "__PRIVATE_BundleReaderSyncImpl");
var __PRIVATE_BundleReaderSyncImpl = ___PRIVATE_BundleReaderSyncImpl;
var _Transaction$2 = class _Transaction$2 {
  constructor(e) {
  ...
  lookup(e) {
    return __async(this, null, function* () {
      ...
      const t = yield (/* @__PURE__ */ __name(function __PRIVATE_invokeBatchGetDocumentsRpc(e2, t2) {
        return __async(this, null, function* () {
  ...
  commit() {
    return __async(this, null, function* () {
      ...
      })), yield (/* @__PURE__ */ __name(function __PRIVATE_invokeCommitRpc(e2, t) {
        return __async(this, null, function* () {
          const n = __PRIVATE_debugCast(e2), r = {
...
__name(_Transaction$2, "Transaction$2");
var Transaction$2 = _Transaction$2;
var ___PRIVATE_TransactionRunner = class ___PRIVATE_TransactionRunner {
  constructor(e, t, n, r, i) {
...
__name(___PRIVATE_TransactionRunner, "__PRIVATE_TransactionRunner");
var __PRIVATE_TransactionRunner = ___PRIVATE_TransactionRunner;
...
function __PRIVATE_firestoreClientEnableNetwork(e) {
  return e.asyncQueue.enqueue((() => __async(null, null, function* () {
    ...
    return t.setNetworkEnabled(true), (/* @__PURE__ */ __name(function __PRIVATE_remoteStoreEnableNetwork(e2) {
      const t2 = __PRIVATE_debugCast(e2);
      return t2.Ia.delete(
        0
        /* OfflineCause.UserDisabled */
      ), __PRIVATE_enableNetworkInternal(t2);
    }, "__PRIVATE_remoteStoreEnableNetwork"))(n);
  })));
}
...
function __PRIVATE_firestoreClientDisableNetwork(e) {
  return e.asyncQueue.enqueue((() => __async(null, null, function* () {
    const t = yield __PRIVATE_getPersistence(e), n = yield __PRIVATE_getRemoteStore(e);
    return t.setNetworkEnabled(false), (/* @__PURE__ */ __name(function __PRIVATE_remoteStoreDisableNetwork(e2) {
      return __async(this, null, function* () {
        const t2 = __PRIVATE_debugCast(e2);
        t2.Ia.add(
          0
    ...
    }, "__PRIVATE_remoteStoreDisableNetwork"))(n);
  })));
}
...
function __PRIVATE_firestoreClientGetDocumentFromLocalCache(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget((() => __async(null, null, function* () {
    return (/* @__PURE__ */ __name(function __PRIVATE_readDocumentFromCache(e2, t2, n2) {
      return __async(this, null, function* () {
        try {
          const r = yield (/* @__PURE__ */ __name(function __PRIVATE_localStoreReadDocument(e3, t3) {
            const n3 = __PRIVATE_debugCast(e3);
            return n3.persistence.runTransaction("read document", "readonly", ((e4) => n3.localDocuments.getDocument(e4, t3)));
          }, "__PRIVATE_localStoreReadDocument"))(e2, t2);
    ...
    }, "__PRIVATE_readDocumentFromCache"))(yield __PRIVATE_getLocalStore(e), t, n);
  }))), n.promise;
}
...
function __PRIVATE_firestoreClientGetDocumentViaSnapshotListener(e, t, n = {}) {
  ...
  return e.asyncQueue.enqueueAndForget((() => __async(null, null, function* () {
    return (/* @__PURE__ */ __name(function __PRIVATE_readDocumentViaSnapshotListener(e2, t2, n2, r2, i) {
    ...
    }, "__PRIVATE_readDocumentViaSnapshotListener"))(yield __PRIVATE_getEventManager(e), e.asyncQueue, t, n, r);
  }))), r.promise;
}
...
function __PRIVATE_firestoreClientGetDocumentsFromLocalCache(e, t) {
  const n = new __PRIVATE_Deferred();
  return e.asyncQueue.enqueueAndForget((() => __async(null, null, function* () {
    return (/* @__PURE__ */ __name(function __PRIVATE_executeQueryFromCache(e2, t2, n2) {
      return __async(this, null, function* () {
        try {
    ...
    }, "__PRIVATE_executeQueryFromCache"))(yield __PRIVATE_getLocalStore(e), t, n);
  }))), n.promise;
}
...
function __PRIVATE_firestoreClientGetDocumentsViaSnapshotListener(e, t, n = {}) {
  const r = new __PRIVATE_Deferred();
  return e.asyncQueue.enqueueAndForget((() => __async(null, null, function* () {
    return (/* @__PURE__ */ __name(function __PRIVATE_executeQueryViaSnapshotListener(e2, t2, n2, r2, i) {
      const s = new __PRIVATE_AsyncObserver({
      ...
      return __PRIVATE_eventManagerListen(e2, o);
    }, "__PRIVATE_executeQueryViaSnapshotListener"))(yield __PRIVATE_getEventManager(e), e.asyncQueue, t, n, r);
  }))), r.promise;
}
...
function __PRIVATE_firestoreClientRunAggregateQuery(e, t, n) {
  ...
  return e.asyncQueue.enqueueAndForget((() => __async(null, null, function* () {
    try {
      ...
      r.resolve((/* @__PURE__ */ __name(function __PRIVATE_invokeRunAggregationQueryRpc(e2, t2, n2) {
        return __async(this, null, function* () {
          var r2;
      ...
      }, "__PRIVATE_invokeRunAggregationQueryRpc"))(i, t, n));
    } catch (e2) {
      r.reject(e2);
    }
  }))), r.promise;
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget((() => __async(null, null, function* () {
    return (/* @__PURE__ */ __name(function __PRIVATE_addSnapshotsInSyncListener(e2, t2) {
      __PRIVATE_debugCast(e2).Da.add(t2), // Immediately fire an initial event, indicating all existing listeners
      // are in-sync.
      t2.next();
    }, "__PRIVATE_addSnapshotsInSyncListener"))(yield __PRIVATE_getEventManager(e), n);
  }))), () => {
    n.Ou(), e.asyncQueue.enqueueAndForget((() => __async(null, null, function* () {
      return (/* @__PURE__ */ __name(function __PRIVATE_removeSnapshotsInSyncListener(e2, t2) {
        __PRIVATE_debugCast(e2).Da.delete(t2);
      }, "__PRIVATE_removeSnapshotsInSyncListener"))(yield __PRIVATE_getEventManager(e), n);
    })));
  };
}
...
function __PRIVATE_firestoreClientLoadBundle(e, t, n, r) {
  const i = (/* @__PURE__ */ __name(function __PRIVATE_createBundleReader(e2, t2) {
    let n2;
    n2 = "string" == typeof e2 ? __PRIVATE_newTextEncoder().encode(e2) : e2;
    return (/* @__PURE__ */ __name(function __PRIVATE_newBundleReader(e3, t3) {
      return new __PRIVATE_BundleReaderImpl(e3, t3);
    }, "__PRIVATE_newBundleReader"))((/* @__PURE__ */ __name(function __PRIVATE_toByteStreamReader(e3, t3) {
    ...
    }, "__PRIVATE_toByteStreamReader"))(n2), t2);
  }, "__PRIVATE_createBundleReader"))(n, __PRIVATE_newSerializer(t));
...
function __PRIVATE_firestoreClientGetNamedQuery(e, t) {
  return e.asyncQueue.enqueue((() => __async(null, null, function* () {
    return (/* @__PURE__ */ __name(function __PRIVATE_localStoreGetNamedQuery(e2, t2) {
      const n = __PRIVATE_debugCast(e2);
      return n.persistence.runTransaction("Get named query", "readonly", ((e3) => n.Ti.getNamedQuery(e3, t2)));
    }, "__PRIVATE_localStoreGetNamedQuery"))(yield __PRIVATE_getLocalStore(e), t);
  })));
}
...
function __PRIVATE_createBundleReaderSync(e, t) {
  return (/* @__PURE__ */ __name(function __PRIVATE_newBundleReaderSync(e2, t2) {
    return new __PRIVATE_BundleReaderSyncImpl(e2, t2);
  }, "__PRIVATE_newBundleReaderSync"))(e, t);
}
__name(__PRIVATE_createBundleReaderSync, "__PRIVATE_createBundleReaderSync");
function __PRIVATE_firestoreClientSetIndexConfiguration(e, t) {
  return e.asyncQueue.enqueue((() => __async(null, null, function* () {
    return (/* @__PURE__ */ __name(function __PRIVATE_localStoreConfigureFieldIndexes(e2, t2) {
      return __async(this, null, function* () {
        ...
        return n.persistence.runTransaction("Configure indexes", "readwrite", ((e3) => r.getFieldIndexes(e3).next(((n2) => (
          ...
          */
          (/* @__PURE__ */ __name(function __PRIVATE_diffArrays(e4, t3, n3, r2, i2) {
            ...
            for (; _ < o; ) r2(t3[_++]);
            for (; a < s; ) i2(e4[a++]);
          }, "__PRIVATE_diffArrays"))(n2, t2, __PRIVATE_fieldIndexSemanticComparator, ((t3) => {
    ...
    }, "__PRIVATE_localStoreConfigureFieldIndexes"))(yield __PRIVATE_getLocalStore(e), t);
  })));
}
...
function __PRIVATE_firestoreClientSetPersistentCacheIndexAutoCreationEnabled(e, t) {
  return e.asyncQueue.enqueue((() => __async(null, null, function* () {
    return (/* @__PURE__ */ __name(function __PRIVATE_localStoreSetIndexAutoCreationEnabled(e2, t2) {
      __PRIVATE_debugCast(e2).Cs.Rs = t2;
    }, "__PRIVATE_localStoreSetIndexAutoCreationEnabled"))(yield __PRIVATE_getLocalStore(e), t);
  })));
}
...
function __PRIVATE_firestoreClientDeleteAllFieldIndexes(e) {
  return e.asyncQueue.enqueue((() => __async(null, null, function* () {
    return (/* @__PURE__ */ __name(function __PRIVATE_localStoreDeleteAllFieldIndexes(e2) {
    ...
    }, "__PRIVATE_localStoreDeleteAllFieldIndexes"))(yield __PRIVATE_getLocalStore(e));
  })));
}
...
var _FirestoreSettingsImpl = class _FirestoreSettingsImpl {
  constructor(e) {
    ...
    ), this.experimentalLongPollingOptions = __PRIVATE_cloneLongPollingOptions(null !== (n = e.experimentalLongPollingOptions) && void 0 !== n ? n : {}), (/* @__PURE__ */ __name(function __PRIVATE_validateLongPollingOptions(e2) {
...
function collectionGroup(e, t) {
  ...
  return new Query(
    ...
    }, "__PRIVATE_newQueryForCollectionGroup"))(t)
  );
}
...
function __PRIVATE_isPartialObserver(e) {
  return (/* @__PURE__ */ __name(function __PRIVATE_implementsAnyMethods(e2, t) {
...
var _LoadBundleTask = class _LoadBundleTask {
  constructor() {
...
__name(_LoadBundleTask, "LoadBundleTask");
var LoadBundleTask = _LoadBundleTask;
var un = -1;
...
function __PRIVATE_configureFirestore(e) {
  var t, n, r;
  const i = e._freezeSettings(), s = (/* @__PURE__ */ __name(function __PRIVATE_makeDatabaseInfo(e2, t2, n2, r2) {
  ...
  }, "__PRIVATE_makeDatabaseInfo"))(e._databaseId, (null === (t = e._app) || void 0 === t ? void 0 : t.options.appId) || "", e._persistenceKey, i);
  ...
  }), e._firestoreClient = new FirestoreClient(e._authCredentials, e._appCheckCredentials, e._queue, s, e._componentsProvider && (/* @__PURE__ */ __name(function __PRIVATE_buildComponentProvider(e2) {
...
function enableIndexedDbPersistence(e, t) {
  ...
  return __PRIVATE_setPersistenceProviders(e, OnlineComponentProvider.provider, {
    build: /* @__PURE__ */ __name((e2) => new __PRIVATE_IndexedDbOfflineComponentProvider(e2, n.cacheSizeBytes, null == t ? void 0 : t.forceOwnership), "build")
  }), Promise.resolve();
}
...
function enableMultiTabIndexedDbPersistence(e) {
  return __async(this, null, function* () {
    ...
    __PRIVATE_setPersistenceProviders(e, OnlineComponentProvider.provider, {
      build: /* @__PURE__ */ __name((e2) => new __PRIVATE_MultiTabOfflineComponentProvider(e2, t.cacheSizeBytes), "build")
    });
  });
}
...
function clearIndexedDbPersistence(e) {
  ...
  return e._queue.enqueueAndForgetEvenWhileRestricted((() => __async(null, null, function* () {
    try {
      yield (/* @__PURE__ */ __name(function __PRIVATE_indexedDbClearPersistence(e2) {
        return __async(this, null, function* () {
          if (!__PRIVATE_SimpleDb.C()) return Promise.resolve();
          const t2 = e2 + qt;
          yield __PRIVATE_SimpleDb.delete(t2);
        });
      }, "__PRIVATE_indexedDbClearPersistence"))(__PRIVATE_indexedDbStoragePrefix(e._databaseId, e._persistenceKey)), t.resolve();
    } catch (e2) {
      t.reject(e2);
    }
  }))), t.promise;
...
var _AggregateField = class _AggregateField {
  /**
...
__name(_AggregateField, "AggregateField");
var AggregateField = _AggregateField;
var _AggregateQuerySnapshot = class _AggregateQuerySnapshot {
  /** @hideconstructor */
  constructor(e, t, n) {
...
__name(_AggregateQuerySnapshot, "AggregateQuerySnapshot");
var AggregateQuerySnapshot = _AggregateQuerySnapshot;
...
var _ParsedUpdateData = class _ParsedUpdateData {
  constructor(e, t, n) {
    this.data = e, this.fieldMask = t, this.fieldTransforms = n;
  }
  toMutation(e, t) {
...
__name(_ParsedUpdateData, "ParsedUpdateData");
var ParsedUpdateData = _ParsedUpdateData;
...
var ___PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(e) {
...
__name(___PRIVATE_DeleteFieldValueImpl, "__PRIVATE_DeleteFieldValueImpl");
var __PRIVATE_DeleteFieldValueImpl = ___PRIVATE_DeleteFieldValueImpl;
...
var ___PRIVATE_ArrayUnionFieldValueImpl = class ___PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
  constructor(e, t) {
    super(e), this.vc = t;
  }
  _toFieldTransform(e) {
...
__name(___PRIVATE_ArrayUnionFieldValueImpl, "__PRIVATE_ArrayUnionFieldValueImpl");
var __PRIVATE_ArrayUnionFieldValueImpl = ___PRIVATE_ArrayUnionFieldValueImpl;
var ___PRIVATE_ArrayRemoveFieldValueImpl = class ___PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
  constructor(e, t) {
    super(e), this.vc = t;
  }
  _toFieldTransform(e) {
...
__name(___PRIVATE_ArrayRemoveFieldValueImpl, "__PRIVATE_ArrayRemoveFieldValueImpl");
var __PRIVATE_ArrayRemoveFieldValueImpl = ___PRIVATE_ArrayRemoveFieldValueImpl;
var ___PRIVATE_NumericIncrementFieldValueImpl = class ___PRIVATE_NumericIncrementFieldValueImpl extends FieldValue {
  constructor(e, t) {
    super(e), this.Cc = t;
  }
  _toFieldTransform(e) {
...
__name(___PRIVATE_NumericIncrementFieldValueImpl, "__PRIVATE_NumericIncrementFieldValueImpl");
var __PRIVATE_NumericIncrementFieldValueImpl = ___PRIVATE_NumericIncrementFieldValueImpl;
...
function query(e, t, ...n) {
  let r = [];
  t instanceof AppliableConstraint && r.push(t), r = r.concat(n), (/* @__PURE__ */ __name(function __PRIVATE_validateQueryConstraintArray(e2) {
...
var _QueryFieldFilterConstraint = class _QueryFieldFilterConstraint extends QueryConstraint {
  ...
  _parse(e) {
    const t = __PRIVATE_newUserDataReader(e.firestore), n = (/* @__PURE__ */ __name(function __PRIVATE_newQueryFilter(e2, t2, n2, r, i, s, o) {
      let _;
      if (i.isKeyField()) {
      ...
      return a;
    }, "__PRIVATE_newQueryFilter"))(e._query, "where", t, e.firestore._databaseId, this._field, this._op, this._value);
    return n;
  }
};
...
var _QueryCompositeFilterConstraint = class _QueryCompositeFilterConstraint extends AppliableConstraint {
  ...
  _apply(e) {
    const t = this._parse(e);
    return 0 === t.getFilters().length ? e : ((/* @__PURE__ */ __name(function __PRIVATE_validateNewFilter(e2, t2) {
      let n = e2;
    ...
    }, "__PRIVATE_validateNewFilter"))(e._query, t), new Query(e.firestore, e.converter, __PRIVATE_queryWithAddedFilter(e._query, t)));
  }
...
var _QueryOrderByConstraint = class _QueryOrderByConstraint extends QueryConstraint {
  ...
  _apply(e) {
    const t = (/* @__PURE__ */ __name(function __PRIVATE_newQueryOrderBy(e2, t2, n) {
    ...
    return new Query(e.firestore, e.converter, (/* @__PURE__ */ __name(function __PRIVATE_queryWithAddedOrderBy(e2, t2) {
    ...
    }, "__PRIVATE_queryWithAddedOrderBy"))(e._query, t));
  }
};
...
var _QueryStartAtConstraint = class _QueryStartAtConstraint extends QueryConstraint {
  /**
   * @internal
   */
  constructor(e, t, n) {
  ...
  _apply(e) {
    ...
    return new Query(e.firestore, e.converter, (/* @__PURE__ */ __name(function __PRIVATE_queryWithStartAt(e2, t2) {
    ...
    }, "__PRIVATE_queryWithStartAt"))(e._query, t));
  }
};
__name(_QueryStartAtConstraint, "QueryStartAtConstraint");
var QueryStartAtConstraint = _QueryStartAtConstraint;
function startAt(...e) {
...
var _QueryEndAtConstraint = class _QueryEndAtConstraint extends QueryConstraint {
  /**
   * @internal
   */
  constructor(e, t, n) {
  ...
  _apply(e) {
    const t = __PRIVATE_newQueryBoundFromDocOrFields(e, this.type, this._docOrFields, this._inclusive);
    return new Query(e.firestore, e.converter, (/* @__PURE__ */ __name(function __PRIVATE_queryWithEndAt(e2, t2) {
    ...
    }, "__PRIVATE_queryWithEndAt"))(e._query, t));
  }
};
__name(_QueryEndAtConstraint, "QueryEndAtConstraint");
var QueryEndAtConstraint = _QueryEndAtConstraint;
...
function __PRIVATE_newQueryBoundFromDocOrFields(e, t, n, r) {
  if (n[0] = getModularInstance(n[0]), n[0] instanceof DocumentSnapshot$1) return (/* @__PURE__ */ __name(function __PRIVATE_newQueryBoundFromDocument(e2, t2, n2, r2, i) {
  ...
  }, "__PRIVATE_newQueryBoundFromDocument"))(e._query, e.firestore._databaseId, t, n[0]._document, r);
  {
    const i = __PRIVATE_newUserDataReader(e.firestore);
    return (/* @__PURE__ */ __name(function __PRIVATE_newQueryBoundFromFields(e2, t2, n2, r2, i2, s) {
    ...
    }, "__PRIVATE_newQueryBoundFromFields"))(e._query, e.firestore._databaseId, i, t, n, r);
  }
}
...
function __PRIVATE_validateNewFieldFilter(e, t) {
  const n = (/* @__PURE__ */ __name(function __PRIVATE_findOpInsideFilters(e2, t2) {
...
var ___PRIVATE_LiteUserDataWriter = class ___PRIVATE_LiteUserDataWriter extends AbstractUserDataWriter {
  constructor(e) {
...
__name(___PRIVATE_LiteUserDataWriter, "__PRIVATE_LiteUserDataWriter");
var __PRIVATE_LiteUserDataWriter = ___PRIVATE_LiteUserDataWriter;
function sum(e) {
...
__name(documentSnapshotFromJSON, "documentSnapshotFromJSON");
...
var _QuerySnapshot = class _QuerySnapshot {
  ...
  docChanges(e = {}) {
    ...
    (/* @__PURE__ */ __name(function __PRIVATE_changesFromSnapshot(e2, t2) {
    ...
    }, "__PRIVATE_changesFromSnapshot"))(this, t), this._cachedChangesIncludeMetadataChanges = t), this._cachedChanges;
  }
  /**
...
__name(querySnapshotFromJSON, "querySnapshotFromJSON");
...
function onSnapshot(e, ...t) {
  ...
  return (/* @__PURE__ */ __name(function __PRIVATE_firestoreClientListen(e2, t2, n2, r2) {
  ...
  }, "__PRIVATE_firestoreClientListen"))(ensureFirestoreConfigured(u), c, _, a);
}
...
function onSnapshotResume(e, t, ...n) {
  const r = getModularInstance(e), i = (
    ...
    * @internal
    */
    (/* @__PURE__ */ __name(function __PRIVATE_normalizeSnapshotJsonFields(e2) {
      const t2 = {
        bundle: "",
        bundleName: "",
        bundleSource: ""
      ...
      return t2;
    }, "__PRIVATE_normalizeSnapshotJsonFields"))(t)
  );
  ...
  if ("object" != typeof n[o] || __PRIVATE_isPartialObserver(n[o]) || (s = n[o++]), "QuerySnapshot" === i.bundleSource) {
    ...
    return (/* @__PURE__ */ __name(function __PRIVATE_onSnapshotQuerySnapshotBundle(e3, t2, n2, r2, i2) {
      let s2, o2 = false;
    ...
    }, "__PRIVATE_onSnapshotQuerySnapshotBundle"))(r, i, s, e2, n[o]);
  }
  if ("DocumentSnapshot" === i.bundleSource) {
    ...
    return (/* @__PURE__ */ __name(function __PRIVATE_onSnapshotDocumentSnapshotBundle(e3, t2, n2, r2, i2) {
      let s2, o2 = false;
      const _ = loadBundle(e3, t2.bundle);
      return _.then((() => {
        if (!o2) {
    ...
    }, "__PRIVATE_onSnapshotDocumentSnapshotBundle"))(r, i, s, e2, n[o]);
  }
  throw new FirestoreError(N.INVALID_ARGUMENT, `unsupported bundle source: ${i.bundleSource}`);
}
__name(onSnapshotResume, "onSnapshotResume");
...
function executeWrite(e, t) {
  return (/* @__PURE__ */ __name(function __PRIVATE_firestoreClientWrite(e2, t2) {
    const n = new __PRIVATE_Deferred();
    return e2.asyncQueue.enqueueAndForget((() => __async(null, null, function* () {
      return __PRIVATE_syncEngineWrite(yield __PRIVATE_getSyncEngine(e2), t2, n);
    }))), n.promise;
  }, "__PRIVATE_firestoreClientWrite"))(ensureFirestoreConfigured(e), t);
}
...
function getAggregateFromServer(e, t) {
  ...
  return __PRIVATE_firestoreClientRunAggregateQuery(r, e._query, i).then(((t2) => (
    ...
    * @internal
    */
    (/* @__PURE__ */ __name(function __PRIVATE_convertToAggregateQuerySnapshot(e2, t3, n2) {
      const r2 = new __PRIVATE_ExpUserDataWriter(e2), i2 = new AggregateQuerySnapshot(t3, r2, n2);
      return i2;
    }, "__PRIVATE_convertToAggregateQuerySnapshot"))(n, e, t2)
  )));
}
__name(getAggregateFromServer, "getAggregateFromServer");
var ___PRIVATE_MemoryLocalCacheImpl = class ___PRIVATE_MemoryLocalCacheImpl {
  constructor(e) {
    this.kind = "memory", this._onlineComponentProvider = OnlineComponentProvider.provider, (null == e ? void 0 : e.garbageCollector) ? this._offlineComponentProvider = e.garbageCollector._offlineComponentProvider : this._offlineComponentProvider = {
      build: /* @__PURE__ */ __name(() => new __PRIVATE_LruGcMemoryOfflineComponentProvider(void 0), "build")
    };
  }
  toJSON() {
    return {
...
__name(___PRIVATE_MemoryLocalCacheImpl, "__PRIVATE_MemoryLocalCacheImpl");
var __PRIVATE_MemoryLocalCacheImpl = ___PRIVATE_MemoryLocalCacheImpl;
var ___PRIVATE_PersistentLocalCacheImpl = class ___PRIVATE_PersistentLocalCacheImpl {
  constructor(e) {
    let t;
...
__name(___PRIVATE_PersistentLocalCacheImpl, "__PRIVATE_PersistentLocalCacheImpl");
var __PRIVATE_PersistentLocalCacheImpl = ___PRIVATE_PersistentLocalCacheImpl;
var ___PRIVATE_MemoryEagerGarbageCollectorImpl = class ___PRIVATE_MemoryEagerGarbageCollectorImpl {
  constructor() {
...
__name(___PRIVATE_MemoryEagerGarbageCollectorImpl, "__PRIVATE_MemoryEagerGarbageCollectorImpl");
var __PRIVATE_MemoryEagerGarbageCollectorImpl = ___PRIVATE_MemoryEagerGarbageCollectorImpl;
var ___PRIVATE_MemoryLruGarbageCollectorImpl = class ___PRIVATE_MemoryLruGarbageCollectorImpl {
  constructor(e) {
    this.kind = "memoryLru", this._offlineComponentProvider = {
      build: /* @__PURE__ */ __name(() => new __PRIVATE_LruGcMemoryOfflineComponentProvider(e), "build")
    };
  }
  toJSON() {
    return {
...
__name(___PRIVATE_MemoryLruGarbageCollectorImpl, "__PRIVATE_MemoryLruGarbageCollectorImpl");
var __PRIVATE_MemoryLruGarbageCollectorImpl = ___PRIVATE_MemoryLruGarbageCollectorImpl;
...
var ___PRIVATE_SingleTabManagerImpl = class ___PRIVATE_SingleTabManagerImpl {
  constructor(e) {
  ...
  _initialize(e) {
    this._onlineComponentProvider = OnlineComponentProvider.provider, this._offlineComponentProvider = {
      build: /* @__PURE__ */ __name((t) => new __PRIVATE_IndexedDbOfflineComponentProvider(t, null == e ? void 0 : e.cacheSizeBytes, this.forceOwnership), "build")
    };
  }
};
__name(___PRIVATE_SingleTabManagerImpl, "__PRIVATE_SingleTabManagerImpl");
var __PRIVATE_SingleTabManagerImpl = ___PRIVATE_SingleTabManagerImpl;
var ___PRIVATE_MultiTabManagerImpl = class ___PRIVATE_MultiTabManagerImpl {
  constructor() {
  ...
  _initialize(e) {
    this._onlineComponentProvider = OnlineComponentProvider.provider, this._offlineComponentProvider = {
      build: /* @__PURE__ */ __name((t) => new __PRIVATE_MultiTabOfflineComponentProvider(t, null == e ? void 0 : e.cacheSizeBytes), "build")
    };
  }
};
__name(___PRIVATE_MultiTabManagerImpl, "__PRIVATE_MultiTabManagerImpl");
var __PRIVATE_MultiTabManagerImpl = ___PRIVATE_MultiTabManagerImpl;
...
var _WriteBatch = class _WriteBatch {
  /** @hideconstructor */
  constructor(e, t) {
...
__name(_WriteBatch, "WriteBatch");
var WriteBatch = _WriteBatch;
...
var _Transaction$1 = class _Transaction$1 {
  /** @hideconstructor */
  constructor(e, t) {
...
__name(_Transaction$1, "Transaction$1");
var Transaction$1 = _Transaction$1;
var _Transaction = class _Transaction extends Transaction$1 {
...
function runTransaction(e, t, n) {
  ...
  }, "__PRIVATE_validateTransactionOptions"))(r);
  return (/* @__PURE__ */ __name(function __PRIVATE_firestoreClientTransaction(e2, t2, n2) {
  ...
  }, "__PRIVATE_firestoreClientTransaction"))(ensureFirestoreConfigured(e), ((n2) => t(new Transaction(e, n2))), r);
}
...
function setIndexConfiguration(e, t) {
  ...
  const r = (/* @__PURE__ */ __name(function __PRIVATE_parseIndexes(e2) {
    const t2 = "string" == typeof e2 ? (/* @__PURE__ */ __name(function __PRIVATE_tryParseJson(e3) {
      try {
        return JSON.parse(e3);
      } catch (e4) {
        throw new FirestoreError(N.INVALID_ARGUMENT, "Failed to parse JSON: " + (null == e4 ? void 0 : e4.message));
      }
    }, "__PRIVATE_tryParseJson"))(e2) : e2, n2 = [];
...
var _PersistentCacheIndexManager = class _PersistentCacheIndexManager {
  /** @hideconstructor */
  constructor(e) {
...
__name(_PersistentCacheIndexManager, "PersistentCacheIndexManager");
var PersistentCacheIndexManager = _PersistentCacheIndexManager;
...
var _TestingHooks = class _TestingHooks {
  constructor() {
...
__name(_TestingHooks, "TestingHooks");
var TestingHooks = _TestingHooks;
var ___PRIVATE_TestingHooksSpiImpl = class ___PRIVATE_TestingHooksSpiImpl {
  constructor() {
    this.Fc = /* @__PURE__ */ new Map();
  }
  static get instance() {
    return In || (In = new ___PRIVATE_TestingHooksSpiImpl(), (/* @__PURE__ */ __name(function __PRIVATE_setTestingHooksSpi(e) {
      if (pt) throw new Error("a TestingHooksSpi instance is already set");
      pt = e;
    }, "__PRIVATE_setTestingHooksSpi"))(In)), In;
  }
  ct(e) {
...
__name(___PRIVATE_TestingHooksSpiImpl, "__PRIVATE_TestingHooksSpiImpl");
var __PRIVATE_TestingHooksSpiImpl = ___PRIVATE_TestingHooksSpiImpl;
var In = null;
!(/* @__PURE__ */ __name(function __PRIVATE_registerFirestore(e, t = true) {
  !(/* @__PURE__ */ __name(function __PRIVATE_setSDKVersion(e2) {
    x = e2;
  }, "__PRIVATE_setSDKVersion"))(SDK_VERSION), _registerComponent(new Component("firestore", ((e2, { instanceIdentifier: n, options: r }) => {
    const i = e2.getProvider("app").getImmediate(), s = new Firestore(new __PRIVATE_FirebaseAuthCredentialsProvider(e2.getProvider("auth-internal")), new __PRIVATE_FirebaseAppCheckTokenProvider(i, e2.getProvider("app-check-internal")), (/* @__PURE__ */ __name(function __PRIVATE_databaseIdFromApp(e3, t2) {
    ...
    }, "__PRIVATE_databaseIdFromApp"))(i, n), i);
...
@firebase/firestore/dist/index.esm2017.js:
  ...
  *)
   ...
   *)
*/
//# sourceMappingURL=chunk-3C4YQ3HF.js.map
